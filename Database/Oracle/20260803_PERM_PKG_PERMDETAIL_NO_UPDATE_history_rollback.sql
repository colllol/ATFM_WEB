-- Khoi phuc phan xu ly cu cua PERM_PKG.PERMDETAIL_NO_UPDATE.
...
BEGIN
    ...
    IF DBMS_LOB.INSTR(l_ddl, l_new_marker, 1, 1) = 0 THEN
        DBMS_OUTPUT.PUT_LINE('PERMDETAIL_NO_UPDATE is already in the old state.');
        RETURN;
    END IF;
