BEGIN
    EXECUTE IMMEDIATE '
        CREATE TABLE T_NOTIFICATION (
            ...
            TARGET_TYPE NUMBER(1) DEFAULT 0 NOT NULL,
            CONSTRAINT CK_T_NOTIFICATION_TARGET_TYPE CHECK (TARGET_TYPE IN (0, 1))
        )';
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    INTO V_INDEX_COUNT
    FROM USER_INDEXES
    WHERE INDEX_NAME = 'IX_T_NOTIFICATION_STATE_TIME';

    IF V_INDEX_COUNT > 0 THEN
        EXECUTE IMMEDIATE 'DROP INDEX IX_T_NOTIFICATION_STATE_TIME';
    END IF;
END;
/
...
BEGIN
    ...
    WHERE TABLE_NAME = 'T_NOTIFICATION'
      AND CONSTRAINT_NAME = 'CK_T_NOTIFICATION_STATUS';

    IF V_CONSTRAINT_COUNT > 0 THEN
        EXECUTE IMMEDIATE '
            ALTER TABLE T_NOTIFICATION
            DROP CONSTRAINT CK_T_NOTIFICATION_STATUS';
    END IF;
END;
/

DECLARE
    V_STATUS_COLUMN_COUNT NUMBER;
BEGIN
    SELECT COUNT(*)
    INTO V_STATUS_COLUMN_COUNT
