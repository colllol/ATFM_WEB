<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCDHB14.aspx.cs" Inherits="prjApplication.Report.M14.BCDHB14" %>
                ...
                <td>
                    ...
                    <table class="tblNoidung" style="undefined;table-layout: fixed; width: 100%">
                          ...
                          <tr>
                            ...
                            <td class="tg-031e"><%=_totalfhn %></td>
                            <td class="tg-031e"><%=_totalfhcm %></td>
                            <td class="tg-031e"><%=_totalSc %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-hgcj">ĐỘT XUẤT</td>
                            <td class="tg-031e"><%=_totalfhnNo %></td>
                            <td class="tg-031e"><%=_totalfhcmNo %></td>
                            <td class="tg-031e"><%=_totalNo %></td>
                            <td class="tg-e3zv"><!--- Số chuyến VIP:<br>- Số chuyến Quân sự :--></td>
                          </tr>
                          <tr>
                            <td class="tg-hgcj">TỔNG CỘNG</td>
                            <td class="tg-031e"><%=_totalhn %></td>
                            <td class="tg-031e"><%=_totalhcm %></td>
