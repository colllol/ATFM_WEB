...
{
    public partial class CBTheoLMB_3 : System.Web.UI.Page
    {
        ...
        protected string LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                else
                {
                    ...
                    DataTable dt = _rpDAL.CBTheoLMB_3(_dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                foreach (DataRow r in _dt.Rows)
                {
                    ...
                    kq += "<td class=\"tg-yw4l\">" + r["AMOUNT"].ToString() + "</td>";
                    kq += "</tr>";
                    i++;
                }
            }
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "CBTheoLMB_3_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        }

        protected void btnExcel_Click(object sender, EventArgs e)
        {
            string html = this.RenderToHTML(divContent);
            this.CreateExcel(html, "CBTheoLMB_3_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
        #endregion
    }
}