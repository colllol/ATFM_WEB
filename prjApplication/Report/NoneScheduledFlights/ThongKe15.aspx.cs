...
namespace prjApplication.Report.NoneScheduledFlights
{
    public partial class ThongKe15 : System.Web.UI.Page
    {
        ...
        protected string LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                else
                {
                    ...
                    DataTable dt = _rpDAL.ThongKe15(_dateFrom.Trim(), _dateTo.Trim());
                ...
                for (int j = 0; j < _dt.Rows.Count; j++)
                {
                    ...
                    if (_a != _b)
                    {
                        if (j == 0)
                        {
                            ...
                            _b = _mrow["FPL_VIA"].ToString();
                            _html += "<td class=\"tg-yw4l\" style=\"text-align:center; \">" + _mrow["oper_id"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\" style=\"text-align:center; \">" + _mrow["REAL_CRAFT_TYPE"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\" style=\"text-align:center; \">" + _mrow["FROM_AIRP"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\" style=\"text-align:center; \">" + _mrow["TO_AIRP"].ToString() + "</td>";
                    ...
                    else
                    {
                        ...
                        _html += "<td class=\"tg-yw4l\">" + _mrow["REAL_CRAFT_TYPE"].ToString() + "</td>";
                        _html += "<td class=\"tg-yw4l\">" + _mrow["FROM_AIRP"].ToString() + "</td>";
                        _html += "<td class=\"tg-yw4l\">" + _mrow["TO_AIRP"].ToString() + "</td>";
                        _html += "<td class=\"tg-yw4l\">" + _mrow["AMOUNT"].ToString() + "</td>";
                        _sl += Convert.ToDouble(_mrow["AMOUNT"].ToString());
                        _html += "</tr>";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "ThongKe15_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        }

        protected void btnExcel_Click(object sender, EventArgs e)
        {
            string html = this.RenderToHTML(divContent);
            this.CreateExcel(html, "ThongKe15_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
        #endregion
    }
}