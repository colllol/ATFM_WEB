...
{
    public partial class THSLB_DAY : System.Web.UI.Page
    {
           ...
           // var ax = _rpStaticDAL.SumTest ("HVN","01/03/2017");
            ...
            if (_dt != null)
            {
                ...
                if (_dt.Rows.Count > 0)
                {
                    ...
                    _SumAll = (Convert.ToInt32(_slTongNgay) + Convert.ToInt32(_rpStaticDAL.Sum_Of_Day(_dateFrom))).ToString();

                    lblTongNgay.Text = _TongNgay;
                    //lblSumFir.Text = _SumFir;
                    lblSumFir.Text = _rpStaticDAL.Sum_Of_Day(_dateFrom);
