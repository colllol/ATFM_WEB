...
namespace prjApplication.Report.ReportATFM
{
    public partial class THSLB_MONTH : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request["FromDate"] != null && Request["FromDate"].ToString() != "" && Request["FromDate"].ToString() != String.Empty && Request["ToDate"] != null && Request["ToDate"].ToString() != "" && Request["ToDate"].ToString() != String.Empty)
            {
                ...
                _month = String.Format("{0:MM/yyyy}", _dtime);
        ...
        private string GenDataTable()
        {
            ...
            DataTable _dt = null;
            _dt = _rpStaticDAL.THSLB_Get_HHKVN_MONTH(_dateThang);
            ...
            if (_dt != null)
            {
                ...
                if (_dt.Rows.Count > 0)
                {
                    ...
                    for (int j = 0; j < _dt.Rows.Count; j++)
                    {
                        ...
                        if (_slpurOper == "null") _slpurOper = "0";
                        _html += "<tr>";
                    ...
                    _SumAll = (Convert.ToInt32(_slTongNgay) + Convert.ToInt32(_rpStaticDAL.Sum_Of_Month(_dateThang))).ToString();

                    lblTongNgay.Text = _TongNgay;
                    lblSumFir.Text = _rpStaticDAL.Sum_Of_Month(_dateThang);
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "THSLB_MONTH_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        }

        protected void btnExcel_Click(object sender, EventArgs e)
        {
            string html = this.RenderToHTML(divContent);
            this.CreateExcel(html, "THSLB_MONTH_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
        #endregion
    }
}