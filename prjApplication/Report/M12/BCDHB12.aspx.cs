...
namespace prjApplication.Report.M12
{
    public partial class BCDHB12 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request["FromDate"] != null && Request["FromDate"].ToString() != "" && Request["FromDate"].ToString() != String.Empty && Request["ToDate"] != null && Request["ToDate"].ToString() != "" && Request["ToDate"].ToString() != String.Empty)
            {
                ...
                _craftid = Request["Craft"].ToString();
                if (!IsPostBack)
                {
                    WriteInfoTime();
                    LoadData();
        ...
        protected void LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                {                   
                    DataTable dt = _rpDAL.BCDHB12_Get_Oper_Craft(_craftid,_dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                ...
                {
                    _slchuyen = _rpDAL.BCDHB12_Get_ThSlb_byCraft(_craftid.ToString(), r["fpl_via"].ToString(), _dateFrom, _dateTo);
                    if (_slchuyen == "-1")
                        _slchuyen = "0";
                    ...
                    kq += "<td class=\"tg-yw41l\">" + r["Ma"].ToString() + "</td>";
                    kq += "<td>" + _slchuyen + "</td>";
                    kq += "<td>" + _slchuyen + "</td>";
                    kq += "</tr>";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "REPORT_12_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            divContent.RenderControl(htw);
            string html = sw.ToString();
           this.CreateExcel(html, "REPORT_12_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
