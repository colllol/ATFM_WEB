...
namespace prjApplication.Report.M21
{
    public partial class BB2 : System.Web.UI.Page
    {
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                ...
                {
                    string _slFirHCM = _rpDAL.DHB20_Fn_THSLB_FIRHCM(r["MONTH"].ToString(), _dateFrom.Trim(), _dateTo.Trim());
                    kq += "<tr>";
                    kq += "<td class=\"tg-031e\">" + r["MONTH"].ToString() + "</td>";
                    kq += "<td class=\"tg-031e\">" + _slFirHCM + "</td>";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            divContent.RenderControl(htw);
            string html = sw.ToString();
            this.CreateExcel(html, "BB2_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
