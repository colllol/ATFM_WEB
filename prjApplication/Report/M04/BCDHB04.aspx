<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCDHB04.aspx.cs" Inherits="prjApplication.Report.M04.BCDHB04" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BÁO CÁO SỐ LIỆU FIR </title>
            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO SỐ CHUYẾN BAY QUA CÁC ĐƯỜNG HÀNG KHÔNG QUỐC TẾ 
VÀ QUỐC NỘI TRONG CÁC VÙNG THÔNG BÁO BAY (FIR)
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="tgNoiDung" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <th class="tg-hgcj">TT</th>
                            <th class="tg-hgcj">Tên đường Hàng không</th>
                            <th class="tg-hgcj" colspan="2">TH tháng  <%=_ThangNay %>,( <%=_SoNgay1 %> ngày)</th>
                            <th class="tg-hgcj" colspan="2">So với tháng,trước <%=_ThangTruoc %> ( <%=_SoNgay2 %> ngày)</th>
                            <th class="tg-hgcj">So sánh %/ngày</th>
                        </tr>
                        <tr>
                            <td class="tg-031e"></td>
                            <td class="tg-031e"></td>
                            <td class="tg-031e">Thực hiện tháng <%=_ThangNay %></td>
                            <td class="tg-031e">Số ch/ngày</td>
                            <td class="tg-031e">Thực hiện tháng <%=_ThangTruoc %></td>
                            <td class="tg-031e">Số ch/ngày</td>
                            <td class="tg-031e"></td>
                        </tr>
                        <%=_content %>
