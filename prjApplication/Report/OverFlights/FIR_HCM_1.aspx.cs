...
{
    public partial class FIR_HCM_1 : System.Web.UI.Page
    {
        ...
        protected string LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                else
                {
                    ...
                    DataTable dt = _rpDAL.FIR_HCM_1(_dateFrom.Trim(), _dateTo.Trim());
            ...
            if (_dt != null)
            {
                ...
                for (int j = 0; j < _dt.Rows.Count; j++)
                {
                    ...
                    if (_a != _b)
                    {
                        ...
                        {
                            _html += "<tr>";
                            _html += "<td class=\"tg -031e\" colspan=\"3\" style=\"text-align:center; \"><b>Sum Of Flights</b></td>";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "FIR_HCM_1" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        }

        protected void btnExcel_Click(object sender, EventArgs e)
        {
            string html = this.RenderToHTML(divContent);
            this.CreateExcel(html, "FIR_HCM_1" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
        #endregion
    }
}