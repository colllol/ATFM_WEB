...
{
    public partial class FIR_HCM : System.Web.UI.Page
    {
        ...
        protected string LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                else
                {
                    ...
                    DataTable dt = _rpDAL.FIR_HCM(_dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                ...
                {
                    _mrow = _dt.Rows[j];
                    _a = _mrow["OPER_ID"].ToString();
                    if (_a != _b)
                    {
                        if (j == 0)
                        {
                            _html += "<tr>";
                            _html += "<td class=\"tg-yw4l\">" + i + "</td>";
                            _html += "<td class=\"tg-yw4l\">" + _mrow["OPER_ID"].ToString() + "</td>";
                            _b = _mrow["OPER_ID"].ToString();
                            ...
                            _html += "<td class=\"tg-yw4l\">" + _mrow["ETD"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\">" + _mrow["ATA"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\">" + _mrow["PURPOSE"].ToString() + "</td>";
                        ...
                        {
                            _html += "<tr>";
                            _html += "<td class=\"tg -031e\" colspan=\"12\" style=\"text-align:center; \"><b>Sum Of Type" + " " + " " + _b.ToString() + "</b></td>";
                            //_html += "<td class=\"tg -031e\"><b>" + _sl + "</b></td>";
                            _html += "</tr>";
                            _sl = 0;
                            _html += "<tr>";
                            _html += "<td class=\"tg-yw4l\">" + (i + 1) + "</td>";
                            _html += "<td class=\"tg-yw4l\">" + _mrow["OPER_ID"].ToString() + "</td>";
                            _b = _mrow["OPER_ID"].ToString();
                            _html += "<td class=\"tg-yw4l\">" + _mrow["FLIGHTDATE"].ToString() + "</td>";
                            _html += "<td class=\"tg-yw4l\">" + _mrow["FLIGHTNBR"].ToString() + "</td>";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "FIR_HCM" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        }

        protected void btnExcel_Click(object sender, EventArgs e)
        {
            string html = this.RenderToHTML(divContent);
            this.CreateExcel(html, "FIR_HCM" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
        #endregion
    }
}