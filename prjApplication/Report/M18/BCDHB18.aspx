<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCDHB18.aspx.cs" Inherits="prjApplication.Report.M18.BCDHB18" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>+ BÁO CÁO SỐ LIỆU ĐIỀU HÀNH BAY CÁC HÃNG HK QUỐC TẾ ĐI ĐẾN THEO ĐƠN VỊ</title>
                ...
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">
                              BÁO CÁO SỐ LIỆU ĐIỀU HÀNH BAY CÁC HÃNG HK QUỐC TẾ ĐI ĐẾN THEO ĐƠN VỊ 
                            </td>                                                     
                        </tr>
                        <tr>
                    ...
                    <table class="tblNoidung" style="undefined; table-layout: fixed; width: 100%">
                          ...
                          <tr>
                            ...
                            <td class="tg-031e">Miền Bắc</td>
                            <td class="tg-031e"><%=_slqtmb %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-s6z2">2</td>
                            <td class="tg-031e">Miền Trung</td>
                            <td class="tg-031e"><%=_slqtmt %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-s6z2">3</td>
                            <td class="tg-031e">Miền Nam</td>
                            <td class="tg-031e"><%=_slqtmn %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-031e"></td>
                            <td class="tg-s6z2">Cộng</td>
                            <td class="tg-031e"><%=_sum2 %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="tg-s6z2">1</td>
                            <td class="tg-031e">Miền Bắc</td>
                            <td class="tg-031e"><%=_slqnmb %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-s6z2">2</td>
                            <td class="tg-031e">Miền Trung</td>
                            <td class="tg-031e"><%=_slqnmt %></td>
                            <td class="tg-031e"></td>
                          </tr>
                          <tr>
                            <td class="tg-s6z2">3</td>
                            <td class="tg-031e">Miền Nam</td>
                            <td class="tg-031e"><%=_slqnmn %></td>
                            <td class="tg-031e"></td>
                          </tr>                  
                          <tr>
                            <td class="tg-yw4l"></td>
                            <td class="tg-baqh">Cộng</td>
                            <td class="tg-yw4l"><%=_sum1 %></td>
                            <td class="tg-yw4l"></td>
                          </tr>
                    </table>                   
                </td>
