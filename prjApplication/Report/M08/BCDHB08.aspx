<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCDHB08.aspx.cs" Inherits="prjApplication.Report.M08.BCDHB08" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BÁO CÁO DANH SÁCH CÁC CHUYẾN BAY VIP, BAY QUÂN SỰ QUÁ CẢNH</title>
            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO DANH SÁCH CÁC CHUYẾN BAY VIP, BAY QUÂN SỰ QUÁ CẢNH
                    ...
                    <br />
                    <span style="font-style:italic;">(Yêu cầu gửi kèm theo phép bay của từng chuyến bay )</span><br /><br /><br />
