...
namespace prjApplication.Report.M13
{
    public partial class BCDHB13 : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                {
                    DataTable dt = _rpDAL.BCDHB13_Get_Oper_Craft(_craftid, _dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                ...
                {
                    _slchuyen = _rpDAL.BCDHB13_Get_ThSlb_byCraft(_craftid.ToString(), r["fpl_via"].ToString(), _dateFrom, _dateTo);
                    if (_slchuyen == "-1")
                        _slchuyen = "0";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "REPORT_13_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            divContent.RenderControl(htw);
            string html = sw.ToString();
            this.CreateExcel(html, "REPORT_13_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
