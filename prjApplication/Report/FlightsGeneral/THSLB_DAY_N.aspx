<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="THSLB_DAY_N.aspx.cs" Inherits="prjApplication.Report.FlightsGeneral.THSLB_DAY_N" %>
                ...
                <tr>
                    <td>
                        ...
                        <table class="tgTHSL" style="undefined; table-layout: fixed; width: 1088px">
                            ...
                            <tr>
                                <td class="tg-amwm" colspan="7" style="text-align:center">Tổng số các chuyến bay đi đến trong ngày</td>
                            ...
                            <tr>
                                <td class="tg-yw4l"></td>
                                <td class="tg-yw4l" colspan="3" style="text-align:center">QUÁ CẢNH</td>
                                <td class="tg-yw4l" style="text-align:center">
                            ...
                            <tr>
                                <td class="tg-amwm" colspan="7">Tổng số các chuyến bay trong ngày :</td>
                                <td class="tg-yw4l" style="text-align:center">
                                    <b>
