<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BTNuoc_NoSum.aspx.cs" Inherits="prjApplication.Report.VietNameseFlights.BTNuoc_NoSum" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>VIETNAM OPERATOR FLIGHTS</title>
                ...
                <tr>
                    <td>
                        <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                            ...
                            <tr>
                                <td class="tg-asmn" colspan="13" style="text-align:center">
                                    VIETNAM OPERATOR FLIGHTS     
                                </td>
                            </tr>
                            <tr >
                                <td class="tg-asmn" colspan="13" style="text-align:center">
                        ...
                        <table class="tgNoiDung" style="undefined; table-layout: fixed; width: 100%">
                            ...
                            <tr>
                                ...
                                <th class="tg-031e"><b>OPER</b></th>
                                <th class="tg-031e"><b>DATE</b></th>
                                <th class="tg-031e"><b>CALLSIGN</b></th>
                                <th class="tg-031e"><b>REGIST</b></th>
                                <th class="tg-031e"><b>TYPE</b></th>
                                <th class="tg-031e"><b>FROM</b></th>
                                <th class="tg-031e"><b>TO</b></th>
                                <th class="tg-031e"><b>ROUTE</b></th>
                                <th class="tg-031e"><b>DEP</b></th>
                                <th class="tg-031e"><b>ARR</b></th>
                                <th class="tg-031e"><b>REMARK</b></th>
