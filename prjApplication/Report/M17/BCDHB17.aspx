<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCDHB17.aspx.cs" Inherits="prjApplication.Report.M17.BCDHB17" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>+ BÁO CÁO SỐ LIỆU ĐIỀU HÀNH BAY CÁC HÃNG HK QUỐC TẾ ĐI ĐẾN THEO HÃNG</title>
                    ...
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">
                               BÁO CÁO SỐ LIỆU ĐIỀU HÀNH BAY CÁC HÃNG HK QUỐC TẾ ĐI ĐẾN THEO HÃNG
                            </td>                                                     
                        </tr>
                        <tr>
