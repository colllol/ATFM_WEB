...
namespace prjApplication.Report.M17
{
    public partial class BCDHB17 : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            if (UltilFunc.checkDate(_dateFrom, _dateTo))
            {
                ...
                {
                    DataTable dt = _rpDAL.DHB17_Get_HHKQT_BAYQT(_dateFrom.Trim(), _dateTo.Trim());
                    _content = GenDataTable(dt);

                    DataTable dt1 = _rpDAL.DHB17_Get_HHKQT_BAYQN(_dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                ...
                {
                    slb = _rpDAL.DHB17_THSLB_SUM_QT(r["oper_id"].ToString(), _dateFrom.Trim(), _dateTo.Trim());
        ...
        private string GenDataTable1(DataTable _dt)
        {
            ...
            if (_dt != null)
            {
                foreach (DataRow r in _dt.Rows)
                {
                    slb = _rpDAL.DHB17_THSLB_SUM_QN(r["oper_id"].ToString(), _dateFrom.Trim(), _dateTo.Trim());
                    kq += "<tr>";
                    kq += "<td class=\"tg-031e\">" + (i + 1) + "</td>";
                    kq += "<td class=\"tg-031e\">" + r["oper_id"].ToString() + "</td>";
                    kq += "<td class=\"tg-031e\">" + slb + "</td>";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            this.CreatePDF(html, "REPORT_17_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/StyleReports.css"), System.Drawing.Printing.PaperKind.A4);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            divContent.RenderControl(htw);
            string html = sw.ToString();
            this.CreateExcel(html, "REPORT_17_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleReports.css"));
        }
