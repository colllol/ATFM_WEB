...
{
    public partial class ImportRoute : PageBaseCallBack
    {
        #region private
        class CB
        {
...
VYMD- LADON B214 BQ W21 NOB R474 TEBAK -ZGOW
        ...
        private string btnImport_Click(string thamso)
        {
            ...
            obj.TXTVIA = obj.TXTVIA.Replace("：", ":").Replace("-", " - ").Replace("–", " - ");
            //VTBS-VHHH	A202
            if (string.IsNullOrEmpty(obj.TXTOTHER))
            {
                switch (obj.OPER)
                {
                    case "XAX":
                        obj.TXTVIA = obj.TXTVIA.Replace("MAIN ROUTE:", "").Replace("ALTN ROUTE:", "");
                        break;
                    case "AXM":
                        obj.TXTVIA = GetViaByOper_AXM(obj.TXTVIA);
                        break;
                    //case "AIC":
                    //    return "None";
                    case "AHK":
                        obj.TXTVIA = GetViaByOper_AHK(obj.TXTVIA);
                        break;
                    case "THA":
                        obj.TXTVIA = GetViaByOper_THA(obj.TXTVIA);
                        break;
                    case "CLX":
                        obj.TXTVIA = GetViaByOper_CLX(obj.TXTVIA);
                        break;
                    case "HVN":
                        obj.TXTVIA = GetViaByOper_HVN(obj.TXTVIA);
                        break;
                    case "VJC":
                        obj.TXTVIA = GetViaByOper_VJC(obj.TXTVIA);
                        break;
                    case "PIC":
                        obj.TXTVIA = GetViaByOper_PIC(obj.TXTVIA);
                        break;
                    case "MSR":
                        obj.TXTVIA = GetViaByOper_MSG(obj.TXTVIA);
                        break;
                    case "CBJ":
                        obj.TXTVIA = GetViaByOper_CBJ(obj.TXTVIA);
                        break;
                    case "QTR":
                        obj.TXTVIA = GetViaByOper_QTR(obj.TXTVIA);
                        break;
                    case "SIA":
                        obj.TXTVIA = GetViaByOper_SIA(obj.TXTVIA);
                        break;
                    case "MAS":
                        obj.TXTVIA = GetViaByOper_MAS(obj.TXTVIA);
                        break;
                    case "CQH":
                        obj.TXTVIA = GetViaByOper_CQH(obj.TXTVIA);
                        break;
                    //case "CES":
                    //    obj.TXTVIA = GetViaByOper_CES(obj.TXTVIA);
                    //    break;
                    case "APG":
                        obj.TXTVIA = GetViaByOper_APG(obj.TXTVIA);
                        break;
                    case "DKH":
                        obj.TXTVIA = GetViaByOper_DKH(obj.TXTVIA);
                        break;
                    case "CEB":
                        obj.TXTVIA = GetViaByOper_CEB(obj.TXTVIA);
                        break;
                    case "MKR":
                        obj.TXTVIA = GetViaByOper_MKR(obj.TXTVIA);
                        break;
                    case "MXD":
                        obj.TXTVIA = GetViaByOper_MXD(obj.TXTVIA);
                        break;
                    case "CAL":
                        obj.TXTVIA = GetViaByOper_CAL(obj.TXTVIA);
                        break;
                    case "UAL":
                        obj.TXTVIA = GetViaByOper_UAL(obj.TXTVIA);
                        break;
                    case "UAE":
                        obj.TXTVIA = GetViaByOper_UAE(obj.TXTVIA);
                        break;
                    case "BKP":
                        obj.TXTVIA = GetViaByOper_BKP(obj.TXTVIA);
                        break;
                    case "VFC":
                        obj.TXTVIA = GetViaByOper_VFC(obj.TXTVIA);
                        break;
                    default:
            ...
            else
            {
                ...
                {
                    case "CCA":
                        obj.TXTVIA = GetViaByOper_CCA(obj.TXTVIA);
                        break;
                    case "ETD":
                        obj.TXTVIA = GetViaByOper_ETD(obj.TXTVIA);
                        break;
                    case "SVR":
                        obj.TXTVIA = GetViaByOper_SVR(obj.TXTVIA);
                        obj.TXTOTHER = GetOtherByOper_SVR(obj.TXTOTHER);
                        break;
                }
                obj.Via = GetViaByFlightIMP(GetOtherByRow(obj.TXTOTHER, obj.OPER), GetViaOther(obj.TXTVIA, obj.OPER), obj.OPER);
            }
