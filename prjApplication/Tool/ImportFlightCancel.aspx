<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ImportFlightCancel.aspx.cs" Inherits="prjApplication.Tool.ImportFlightCancel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="mgb_15px">
        <button id="btnSearch" type="button" onclick="btnSearch_Click()" class="btn btn-primary hidden">Search</button>
        <button id="btnImport" type="button" onclick="btnImport_Click()" class="btn btn-primary">Import</button>
        <button id="btnImportAll" type="button" onclick="btnImportAll_Click()" class="btn btn-primary hidden">Import One Format</button>
        <button id="btnUpdate" type="button" onclick="btnUpdate_Click()" class="btn btn-primary hidden">Update</button>
</div>
        <table id="tblSource" class="table table-bordered hidden">
            <thead>
                <tr>
                    <th></th>
