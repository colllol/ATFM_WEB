<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDC_SL_Bay_Hang_QN.aspx.cs" Inherits="prjApplication.RpDHB.BDC_SL_Bay_Hang_QN" %>
...
<head runat="server">
    <title>BẢNG ĐỐI CHIẾU SỐ LIỆU CÁC HÃNG HÀNG KHÔNG TRONG NƯỚC CẤT HẠ CÁNH TẠI CÁC SÂN BAY KHU VỰC</title>
...
<body>
    ...
    <div id="abcxyz" class="well well-sm" style="text-align: center;">
         <b>FROM DATE :</b>
        <input id="txtFromDate" class="datepicker" style="width:100px;" autocomplete="off" runat="server"
            onkeypress='return check_num(this,14,event)' type="text"
            placeholder="select date" />
        <b>TO DATE :</b>
        <input id="txtToDate" class="datepicker" style="width:100px;" autocomplete="off" runat="server"
            onkeypress='return check_num(this,14,event)' type="text"
            placeholder="select date" />

        <select id="ddlMien" class="disabled" runat="server" style="width: 160px;">
            <option value="1">Miền Bắc</option>
            <option value="2">Miền Trung</option>
            <option value="3">Miền Nam</option>
            <option value="4">Tổng Hợp Ba Miền</option>
        </select>
