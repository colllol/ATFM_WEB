...
{
    public partial class RpDHB_SL_CatHa_KHB : System.Web.UI.Page
    {
        ...
        public string BuildHeader()
        {
            ...
            _htmlHeader += "</tr>";
            _htmlHeader += "<tr>";
            _htmlHeader += "<td class=\"tg-5fpg fontRp14\" colspan=\"4\" style = \"text-align:center;\"><span style = \"font-weight:bold;text-align:center;\"> BÁO CÁO THEO KHUNG GIỜ BAY THEO SL KHB</span>";
            _htmlHeader += "</td></tr>";
            _htmlHeader += "<tr>";
        ...
        public string BuildContent()
        {
            ...
            DataTable _dt = _objCC.THSLB_GET_KHB_KHUNGGIO(txtFromDate.Value, txtToDate.Value, txtFromTime.Value, txtToTime.Value);
            ...
            if (_dt != null)
            {
                if (_dt.Rows.Count > 0)
                {
                    for (int j = 0; j < _dt.Rows.Count; j++)
                    {
                        ...
                        {
                            _TotalCat = _objCC.THSLB_GET_KHB_CAT_ETD(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                            _TotalHa = _objCC.THSLB_GET_KHB_HA_ETA(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                        }
                        else if (ddlTime.Value == "ETD")
                        {
                            _TotalCat = _objCC.THSLB_GET_KHB_CAT_ETD(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                            _TotalHa = "0";// _objCC.THSLB_GET_KHB_HA_ETD(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                        }
                        else
                        {
                            _TotalCat = "0";// _objCC.THSLB_GET_KHB_CAT_ETA(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                            _TotalHa = _objCC.THSLB_GET_KHB_HA_ETA(txtFromDate.Value, txtToDate.Value, ddlAERO.SelectedValue, ddlOPER.SelectedValue, _mrow["sf"].ToString(), _mrow["st"].ToString());
                        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            this.CreateExcel(html, "THSLB_KHUNGGIO_KHB_" + DateTime.Now.ToFileTime() + ".xls", Server.MapPath("~/Style/StyleRpDHB.css"));
        }

        protected void btnExportWord_Click(object sender, EventArgs e)
        {
            string html = GetAllContent();
            this.CreateWord(html, "THSLB_KHUNGGIO_KHB_" + DateTime.Now.ToFileTime() + ".doc", Server.MapPath("~/Style/StyleRpDHB.css"));
        }
