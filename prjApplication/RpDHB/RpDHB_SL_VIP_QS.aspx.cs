...
{
    public partial class RpDHB_SL_VIP_QS : System.Web.UI.Page
    {
        ...
        public string BuildHeader()
        {
            ...
            _htmlHeader += "<td class=\"tg-5fpg\" colspan=\"3\"><span style = \"font-weight: bold\"> BÁO CÁO CÁC CHUYẾN BAY VIP , QUÂN SỰ</span><br/><span style = \"font-weight: bold;font-size:13px;\">Tháng " + txtFromDate.Value.ToString().Replace("-", " năm ") + "</span>";
        ...
        public string BuildContent_New()
        {
            ...
            if (!String.IsNullOrEmpty(_fromDate))
                _dt = _DAL.DHB_Fun_List_OF_VIP_QS(_fromDate);
            DataRow _mrow = null;
