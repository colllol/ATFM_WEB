...
{
    public partial class RpDHB_VIA_2FIR_BY_CRAFT : System.Web.UI.Page
    {
        ...
        public string BuildHeader()
        {
            ...
            _htmlHeader += "<tr>";
            if (ddlMien.Value == "1")
                _htmlHeader += "<td class=\"tg-5fpg\" colspan=\"3\"><span style = \"font-weight: bold\"> BÁO CÁO CÁC CHUYẾN BAY QUA FIR HÀ NỘI THEO LOẠI MÁY BAY</span><br/><span style = \"font-weight: bold;font-size:13px;\">Tháng " + txtFromDate.Value.ToString().Replace("-", " năm ") + "</span>";
            else
                _htmlHeader += "<td class=\"tg-5fpg\" colspan=\"3\"><span style = \"font-weight: bold\"> BÁO CÁO CÁC CHUYẾN BAY QUA FIR HỒ CHÍ MINH THEO LOẠI MÁY BAY</span><br/><span style = \"font-weight: bold;font-size:13px;\">Tháng " + txtFromDate.Value.ToString().Replace("-", " năm ") + "</span>";
        ...
        public string BuildContent_New()
        {
            ...
            {
                if (ddlMien.Value == "1")
                    _dt = _DAL.DHB_Fun_List_OF_FIR_HN_CRAFT(_fromDate);
                else
                    _dt = _DAL.DHB_Fun_List_OF_FIR_HCM_CRAFT(_fromDate);
            }
            ...
            _htmlContent += "<th class=\"tg-baqh\"><b>Loại máy bay</b></th>";
