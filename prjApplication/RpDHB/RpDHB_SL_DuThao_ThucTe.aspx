<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RpDHB_SL_DuThao_ThucTe.aspx.cs" Inherits="prjApplication.RpDHB.RpDHB_SL_DuThao_ThucTe" %>
...
<head runat="server">
    <title>THỐNG KÊ ĐỐI CHIẾU SỐ LIỆU DỰ THẢO / THỰC TẾ</title>
...
<body>
    <form id="form2" runat="server">
        ...
        <div id="exportid" runat="server">
            ...
            <div id="contentid" runat="server" style="padding-left:120px;">
