...
{
    public partial class ScheduleFlights4ATS : PageBaseCallBack
    {
        public string _phanCach = "::::";
        public string _PhanCachArg = "_____";
        public string _IdSelect = "0";
        private string _AliasSession = "ScheduleFlights4ATS";
        ...
        private void LoadMultiDropdownList()
        {
            ...
            this.FillDropdownList<Aero>(mFROM_AIRP, new AeroDAL().GetListAll(), "AE_NAME", "AE_CODE");
            this.FillDropdownList<Aero>(mTO_AIRP, new AeroDAL().GetListAll(), "AE_NAME", "AE_CODE");
            ...
            this.FillDropdownList<Aero>(ddlFROM_AIRP_Search, new AeroDAL().GetListAll(), "AE_NAME", "AE_CODE", "--");
            this.FillDropdownList<Aero>(ddlTO_AIRP_Search, new AeroDAL().GetListAll(), "AE_NAME", "AE_CODE", "--");
