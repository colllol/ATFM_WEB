<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true"
    CodeBehind="ScheduleFlights.aspx.cs" Inherits="prjApplication.ScheduleFlights.ScheduleFlights" %>
  ...
  border-right: none;
    ...
    <div class="well well-sm" style="text-align: center;">
        ...
        <!--<div>
            ...
            <button type="button" id="btnCreate" runat="server" class="btn btn-sm btn-primary btn-bold" data-toggle="modal"
                data-target="#MultiAdd">
                <span class="glyphicon glyphicon-plus"></span>
                Create
            </button>
            <input id="txtFromDate" runat="server" type="text" data-date-format="dd/mm/yyyy"
                class="date-picker" placeholder="select date" />
            <asp:Button ID="btnCreateDayFlight" runat="server" OnClientClick="return confirm('Do you want create?');"
                CssClass="btn btn-sm btn-primary btn-bold" Text="Export DailyFlight" OnClick="btnCreateDayFlight_Click" />
            <asp:Button ID="btnRenderCustom" runat="server" OnClientClick="return confirm('Do you want render?');" OnClick="btnRenderCustom_Click" Text="Export custom"
                        ...
                        <tr class='<%# Eval("ISRENDER").ToString()=="1"? "colorRender":"" %>'>
                            ...
                            <td>
                                ...
                                <div class="action-buttons" style="width: 65px" id="divattribute" runat="server">
                                    <a runat="server" visible='<%# _Role.R_Edit%>' data-toggle="tooltip"
                                        title="Edit">
                                    ...
                                    <a runat="server" visible='<%# _Role.R_Del%>' data-toggle="tooltip"
                                        title="Delete">
