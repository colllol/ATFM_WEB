<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="InboxMess.aspx.cs" Inherits="prjApplication.Inbox.InboxMess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <span style="font-weight: bold;">+ VIEW INBOX</span>
                        ...
                        <tr>
                            ...
                            <td style="width: 60%; text-align: left;">
                                ...
                                <%--<asp:LinkButton runat="server" ID="btnAddCountry" CssClass="btn btn-sm btn-primary btn-bold"
                                    OnClientClick="return checkValidCustomMinlenght(formValidate1);" CausesValidation="false">
