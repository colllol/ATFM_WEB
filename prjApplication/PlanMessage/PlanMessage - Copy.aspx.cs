...
{
    public partial class PlanMessage : PageBaseCallBack
    {
        public string _phanCach = "::::";
        public string _IdSelect = "0";
        private string _AliasSession = "PlanMessage";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            System.Data.DataTable t = new prjBusinessLogic.PlanMessageDAL().GetPage(GetSearch());
            ax.DataSource = t;
            ax.DataBind();
            this.CreateExcel(this.RenderToHTML(ax), "PlanMessage_" + DateTime.Now.ToFileTime() + ".xls");
        }
        ...
        private clsSearchPlanMessageNew GetSearch()
        {
            clsSearchPlanMessageNew obj = new clsSearchPlanMessageNew();
        ...
        {
            return new PlanMessageDAL().GetOne(thamso[1].ToString(), thamso[0].ToString(),thamso[2].ToString()).Rows[0]["CONTENT"].ToString();
        }
