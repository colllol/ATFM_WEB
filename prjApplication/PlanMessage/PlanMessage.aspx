<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="PlanMessage.aspx.cs" Inherits="prjApplication.PlanMessage.PlanMessage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="TitlePanel">+ PLAN MESSAGE </span>
        ...
        <asp:GridView ID="grdSource" runat="server" CssClass="table table-bordered table-hover"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="DATE">
                    ...
                    <ItemTemplate>
                        <%# Convert.ToDateTime(Eval("FLIGHTDATE"))!=DateTime.MinValue?Convert.ToDateTime(Eval("FLIGHTDATE")).ToString("dd/MM/yyyy"):"" %>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="CONTENT">
                    ...
                    <ItemTemplate>
                        <span onclick='GetContent(<%# Eval("PART_NO") %>,"<%# Eval("FLIGHTDATE") %>","<%# Eval("MESS_TYPE") %>");' onmouseover="ddrivetip('<%# Eval("CONTENT").ToString().Replace("\n", "</br>").Replace("\"","") %>', 'yellow', 500);"
                ...
                <asp:BoundField DataField="MESS_TYPE" HeaderText="MESS_TYPE" />                
    ...
    <script>
        ...
        function GetContent(id,date,mestype) {
            GetArgWithPostBack(id +'::::'+date +'::::'+mestype+'_____GetContent', 'GetContent');
        }
    </script>
</asp:Content>
