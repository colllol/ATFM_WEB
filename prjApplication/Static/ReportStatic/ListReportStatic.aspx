<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListReportStatic.aspx.cs" Inherits="prjApplication.Static.ReportStatic.ListReportStatic" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <span style="font-weight: bold;">+ REPORT STATIC LIST</span>
                    ...
                    <table border="0" cellspacing="1px" cellspacing="1px" style="text-align: right; width: 100%">
                        <tr>
                            ...
                            <td style="width: 60%; text-align: left;">
                                ...
                                <asp:LinkButton runat="server" ID="btnAddReportStatic" CssClass="btn btn-sm btn-primary btn-bold"
                                    OnClick="btnAddReportStatic_Click" OnClientClick="return checkValidCustomMinlenght(formValidate1);" CausesValidation="false">
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEditUser" runat="server" CssClass="linkGridForm" Text='<%# DataBinder.Eval(Container.DataItem, "NAME_REPORT") %>'
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "ADDRESS_FILE") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
