<%@ Page Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListReportingPoint.aspx.cs" Inherits="prjApplication.Static.REPORTING_POINT.ListReportingPoint" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-weight: bold;">+ REPORTING POINT LIST</span>
                    ...
                    <table border="0" cellspacing="1px" cellspacing="1px" style="text-align: right; width: 100%">
                        <tr>
                            ...
                            <td style="width: 60%; text-align: left;">
                                ...
                                <asp:LinkButton runat="server" ID="btnAddReportingPoint" CssClass="btn btn-sm btn-primary btn-bold"
                                    OnClick="btnAddReportingPoint_Click" CausesValidation="false">
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CssClass="linkGridForm" Text='<%# DataBinder.Eval(Container.DataItem, "POINT_NAME") %>'
                                    ToolTip="Edit ReportingPoint" Enabled='<%#_Role.R_Edit %>' CommandName="Edit"
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle HorizontalAlign="left" Width="12%"></ItemStyle>
                            <HeaderTemplate>
                                COMPULSORY_ON_REQUEST
                            </HeaderTemplate>
                            <ItemTemplate>                                
                                <asp:ImageButton ID="btnCOMPULSORY_ON_REQUEST" runat="server" ImageUrl='<%#IsStatusGet(DataBinder.Eval(Container.DataItem, "COMPULSORY_ON_REQUEST").ToString())%>'
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="btnDelete" Width="25px" runat="server" ImageUrl="~/images/delete.png"
                                    ImageAlign="AbsMiddle" OnClientClick="return confirm('Do you want delete?');" ToolTip="Delete ReportingPoint" CommandName="DeleteReportingPoint"
