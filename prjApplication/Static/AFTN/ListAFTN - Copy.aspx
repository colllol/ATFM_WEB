<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="ListAFTN.aspx.cs" Inherits="prjApplication.Static.AFTN.ListAFTN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-weight: bold;">+ GROUP AFTN LIST</span>
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CssClass="linkGridForm" Text='<%# DataBinder.Eval(Container.DataItem, "GROUP_NAME") %>'
                        ...
                        <%--<asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "G_A_M_ID") %>                               
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "DECRIPTION") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
