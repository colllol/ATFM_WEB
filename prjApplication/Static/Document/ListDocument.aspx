<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListDocument.aspx.cs" EnableEventValidation="false" Inherits="prjApplication.Static.Document.ListDocument" %>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEditUser" runat="server" CssClass="linkGridForm" Text='<%# DataBinder.Eval(Container.DataItem, "NAME") %>'
                                    ToolTip="Edit Document" Enabled='<%#_Role.R_Edit %>' CommandName="Edit"
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="btnDelete" Width="25px" runat="server" ImageUrl="~/images/delete.png"
                                    ImageAlign="AbsMiddle" OnClientClick="return confirm('Do you want delete?');" ToolTip="Delete Document" CommandName="DeleteByID"
