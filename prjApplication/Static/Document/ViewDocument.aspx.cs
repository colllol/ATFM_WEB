...
{
    public partial class ViewDocument : PageCoreAdmin
    {
        private const string _AliasSession = "ViewDocument";
        ...
        protected void grdSource_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "DeleteByID":
                    var kq = new DocumentDAL().DeleteDocument(id);
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txtSearch_UserName.Text.Trim()))
                ax.DataSource = new DocumentDAL().GetListPageExport(GetWhereCondition());
            else
                ax.DataSource = new DocumentDAL().GetListAll();
            ax.DataBind();
            ...
            this.CreatePDF(html, "LISTDocument_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/assets/css/bootstrap1.min.css"), System.Drawing.Printing.PaperKind.A4);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            ax.DataBind();
            this.CreateExcel(this.RenderToHTML(ax), "LISTDocument_" + DateTime.Now.ToFileTime() + ".xls");
        }
