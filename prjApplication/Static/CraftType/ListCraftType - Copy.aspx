<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="ListCraftType.aspx.cs" Inherits="prjApplication.Static.CraftType.ListCraftType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-weight: bold;">+ CRAFT TYPE LIST</span>
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CssClass="linkGridForm" Text='<%# DataBinder.Eval(Container.DataItem, "MA") %>'
                        ...
                        <%--<asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "CRAFT_ID") %>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField>
                            <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "SOHIEU") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "TAITRONG") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%--<asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "NUMBER_CHAIRS") %>
                            </ItemTemplate>
                        </asp:TemplateField>                       
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "YEAR_MANUFACTURE") %>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
