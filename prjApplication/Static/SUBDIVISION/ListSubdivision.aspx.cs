...
{
    public partial class ListSubdivision : PageCoreAdmin
    {
        private const string _AliasSession = "ListSubdivision";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LoadData();
                btnAddSubdivision.Enabled = _Role.R_Add;
            }
        }
        ...
        {
            List<Subdivision> t = new SubdivisionDAL().GetPageSubdivision(CustomPaging1.PageSize, CustomPaging1.PageIndex, CustomPaging1.ValueSearch);
            CustomPaging1.TotalsRecord = t.GetTotalRecord<Subdivision>();
        ...
        private void PutclsSearchDetail()
        {
            ...
            lisSearch.Add(new clsSearchDetail("SUBDIVISION_NAME", "txtSearch_UserName", txtSearch_UserName.Text.Trim()));
        ...
        public string GetWhereCondition()
        {
            ...
            if (!String.IsNullOrEmpty(txtSearch_UserName.Text.Trim()))
                where += " AND " + string.Format(" UPPER(SUBDIVISION_NAME) like N'%{0}%'", UltilFunc.SqlFormatText(this.txtSearch_UserName.Text.Trim().ToUpper()));
        ...
        protected void grdSource_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "DeleteByID":
                    var kq = new SubdivisionDAL().DeleteSubdivision(id.ToString());
                    if (kq) this.AlertMessage("Delete sussess!");
                    else this.AlertMessage("Delete error!");
                    LoadData();
                    break;
                case "Edit":
                    Response.Redirect("~/Static/SUBDIVISION/EditSubdivision.aspx?Menu_ID=" + Page.Request["Menu_ID"].ToString() + "&ID=" + id.ToString());
                    break;
            }
        }
        ...
        protected void btnAddSubdivision_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Static/SUBDIVISION/EditSubdivision.aspx?Menu_ID=" + Page.Request["Menu_ID"].ToString());
        }
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txtSearch_UserName.Text.Trim()))
                ax.DataSource = new SubdivisionDAL().GetPageSubdivisionExport(GetWhereCondition());
            else
                ax.DataSource = new SubdivisionDAL().GetAllSubdivision();
            ...
            this.CreatePDF(html, "LISTSUBDIVISION_" + DateTime.Now.ToFileTime() + ".pdf", Server.MapPath("~/Style/assets/css/bootstrap.min.css"), System.Drawing.Printing.PaperKind.A4);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            ax.DataBind();
            this.CreateExcel(this.RenderToHTML(ax), "LISTSUBDIVISION_" + DateTime.Now.ToFileTime() + ".xls");
        }
