<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="EditSector.aspx.cs" Inherits="prjApplication.Static.SECTOR.EditSector" %>
                    ...
                    <div id="main-content">
                        <div class="content-box">
                            ...
                            <div class="content-box-header">
                                <h3 style="cursor: s-resize; margin-top: 0px; font-size: 12px;">+ EDIT SECTOR</h3>
                            ...
                            <div class="content-box-content">
                                ...
                                <table class="input">
                                    <tbody>
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">SECTOR NAME(<span
                                                class="req_Field">*</span>):
                                                            
                                            </td>
                                            <td class="tdinput tdwidth">
                                                <asp:TextBox ID="txtADDRESS" runat="server" MaxLength="1000" CssClass="text-input" Width="40%"
