<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true"
    CodeBehind="EditFlyPurpose.aspx.cs" Inherits="prjApplication.Static.FLY_PURPOSE.EditFlyPurpose" %>
                    ...
                    <div id="main-content">
                        <div class="content-box">
                            ...
                            <div class="content-box-header">
                                <h3 style="cursor: s-resize; margin-top: 0px; font-size: 12px;">+ EDIT FLY_PURPOSE</h3>
                            ...
                            <div class="content-box-content">
                                ...
                                <table class="input">
                                    <tbody>
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">PURPOSE_CODE(<span
                                                class="req_Field">*</span>):
                                                            
                                            </td>
                                            <td class="tdinput tdwidth">
                                                <asp:TextBox ID="txtPURPOSE_CODE" runat="server" MaxLength="10" CssClass="text-input" Width="40%"
                                                    TabIndex="1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RFVtxtUserName" runat="server" ControlToValidate="txtPURPOSE_CODE"
                                                    Display="Dynamic" ErrorMessage="Chưa nhập PURPOSE_CODE" CssClass="req_Field"
                                        ...
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">PURPOSE_NAME(<span
                                                class="req_Field">*</span>):
                                            </td>
                                            <td class="tdinput">
                                                <asp:TextBox ID="txtPURPOSE_NAME" runat="server" MaxLength="100" CssClass="text-input" Width="40%"
                                                    TabIndex="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPURPOSE_NAME"
                                                    Display="Dynamic" ErrorMessage="Chưa nhập PURPOSE_NAME" Font-Size="Small" SetFocusOnError="True"
