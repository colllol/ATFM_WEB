<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="EditVia.aspx.cs" Inherits="prjApplication.Static.VIA.EditVia" %>
                        ...
                        <div class="content-box">
                            ...
                            <div class="content-box-content">
                                ...
                                <table class="input">
                                    <tbody>
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">NUMBER_NAME(<span
                                                class="req_Field">*</span>):
                                                            
                                            </td>
                                            <td class="tdinput tdwidth">
                                                <asp:TextBox ID="txtEVENT_NAME" runat="server" CssClass="text-input" Width="40%"
                                        ...
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">OPER ICAO(<span
                                                class="req_Field">*</span>):
                                            </td>
                                            <td class="tdinput">
                                        ...
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">CRAFT_TYPE:
                                            </td>
                                            <td class="tdinput">
                                        ...
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">POINT_IN:
                                            </td>
                                            <td class="tdinput">
                                                <input id="txtPOINT_IN" runat="server"  type="text" class="text-input" tabindex="4" />
                                                
                                            </td>
                                        </tr>
                                        
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">POINT_OUT:
                                            </td>
                                            <td class="tdinput">
                                                <input id="txtPOINT_OUT" runat="server"  type="text" class="text-input" tabindex="6" />
                                                
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">FLIGHT LEVER:
                                            </td>
                                            <td class="tdinput">
                                                <input id="txtFLIGHT" runat="server"  type="text" class="text-input" tabindex="5" />
                                                
                                            </td>
                                        </tr>
                                         <tr>
                                            <td style="text-align: right; font-weight: bold;" class="tdinput">ROLE:
                                            </td>
                                            <td class="tdinput">
                                                <input id="txtQUYTAC" runat="server"  type="text" class="text-input" tabindex="7" />
