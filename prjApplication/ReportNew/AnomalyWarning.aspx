<%@ Page Title="Cảnh báo chuyến bay delay" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeFile="AnomalyWarning.aspx.cs" Inherits="prjApplication.ReportNew.AnomalyWarning" %>
