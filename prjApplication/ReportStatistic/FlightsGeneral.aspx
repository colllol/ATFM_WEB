<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/ATFM_New.Master" CodeBehind="FlightsGeneral.aspx.cs" Inherits="prjApplication.ReportStatistic.FlightsGeneral" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script language="Javascript" type="text/javascript">
        function f_CallReports(valuePath) {
            var _fromDate = document.getElementById("<%= txtBEGINDATE.ClientID%>").value;
            var _toDate = document.getElementById("<%= txtENDDATE.ClientID%>").value;
    ...
    <%--<div class="alert alert-block alert-success">
        ...
        <strong class="green">BÁO CÁO THỐNG KÊ										
        </strong>
    </div>--%>
    <div class="row">
                    ...
                    <div class="widget-main">
                        <div class="input-group">
                            ...
                            <input id="txtBEGINDATE" class="datepicker" autocomplete="off" runat="server"
                                style="width: 76%" onkeypress='return check_num(this,14,event)' type="text" />
            ...
            <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a style="cursor: pointer" class="linkGridForm" onclick="f_CallReports('<%# Eval("ADDRESS_FILE") %>'); $(this).css('color','blue')"><%# Eval("NAME_REPORT") %></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
