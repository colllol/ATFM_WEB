            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">
                                BÁO CÁO SỐ LIỆU ĐHB THEO HÃNG CỦA CÁC HÃNG HK QUỐC NỘI
                            </td>                                                     
                        </tr>
                        <tr>
                    ...
                    <table class="tblNoidung" style="undefined; table-layout: fixed; width: 100%">
                          <tr>
                            <th class="tg-s6z2" rowspan="2">Hãng</th>
                            <th class="tg-s6z2" colspan="5">SỐ CHUYẾN BAY QUỐC NỘI</th>
                            <th class="tg-s6z2" colspan="5">SỐ CHUYẾN BAY QUỐC TẾ</th>
                            <th class="tg-s6z2" rowspan="2">TỔNG CỘNG</th>
                          </tr>
                          <tr>
                            <td class="tg-s6z2">SỐ CHUYẾN THƯỜNG LỆ</td>
                            <td class="tg-s6z2">SỐ CHUYẾN VIP</td>
                            <td class="tg-s6z2">SỐ CHUYẾN FERRY</td>
                            <td class="tg-s6z2">SỐ CHUYẾN QUAY LAI</td>
