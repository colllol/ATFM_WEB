<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTMThu02.aspx.cs" Inherits="prjApplication.ReportBTC.QTDD.CTMThu02" %>
...
<head runat="server">
    <title>+ BÁO CÁO SỐ LIỆU CÁC HÃNG HKQT BAY ĐI ĐẾN MIỄN THU</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divContent" runat="server">
                    ...
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 70%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO SỐ LIỆU CÁC HÃNG HKQT BAY ĐI ĐẾN MIỄN THU
                        ...
                        <tr>
                            <td class="tg-s6z2" colspan="3">Đơn vị: VNĐ</td>
                        </tr>
                    </table>
