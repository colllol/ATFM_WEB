<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTTSan01.aspx.cs" Inherits="prjApplication.ReportBTC.QTDD.CTTSan01" %>
...
<head runat="server">
    <title>+ BÁO CÁO SỐ LIỆU THU TIỀN ĐHB CÁC HÃNG HKQT BAY ĐI ĐẾN TẠI SÂN</title>
            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 70%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO SỐ LIỆU THU TIỀN ĐHB CÁC HÃNG HKQT BAY ĐI ĐẾN TẠI SÂN
