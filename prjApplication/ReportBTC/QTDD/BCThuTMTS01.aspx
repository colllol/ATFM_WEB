<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCThuTMTS01.aspx.cs" Inherits="prjApplication.ReportBTC.QTDD.BCThuTMTS01" %>
...
<head runat="server">
    <title>+ BÁO CÁO CÁC CHUYẾN BAY QUỐC TẾ ĐI ĐẾN THU TIỀN MẶT TẠI SÂN</title>
        ...
        <div id="divContent" runat="server">
                    ...
                    <table class="tgHearderList table table-condensed" style="table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            ...
                            <td class="tg-hgcj" colspan="2">BÁO CÁO CÁC CHUYẾN BAY QUỐC TẾ ĐI ĐẾN THU TIỀN MẶT TẠI SÂN</td>
                            <td class="tg-031e"></td>
                        </tr>
                        <tr>
                            <td class="tg-031e"></td>
                        ...
                        <tr>
                            ...
                            <td class="tg-031e" colspan="2"></td>
                            <td class="tg-031e">Currency: VND</td>
                        </tr>
                    </table>
