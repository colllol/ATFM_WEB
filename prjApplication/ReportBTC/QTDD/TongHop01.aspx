...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TongHop01.aspx.cs" Inherits="prjApplication.ReportBTC.QTDD.TongHop01" %>
...
<head runat="server">
    <title>+ BÁO CÁO TỔNG HỢP CÁC HÃNG HÀNG KHÔNG QUỐC TẾ BAY ĐI ĐẾN</title>
            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 70%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO TỔNG HỢP CÁC HÃNG HÀNG KHÔNG QUỐC TẾ BAY ĐI ĐẾN
                        ...
                        <tr>
                            <td class="tg-s6z2" colspan="3">Đơn vị: USD</td>
                        </tr>
                    </table>
                    ...
                    <table class="tgBCQTDD" style="undefined; table-layout: fixed; width: 70%">
                        ...
                        <tr>
                            ...
                            <th class="tg-amwm">DIỄN GIẢI</th>
                            <th class="tg-amwm">SỐ CHUYẾN</th>
                            <th class="tg-amwm">SỐ TIỀN</th>
                        </tr>
                        <tr>
                            <td class="tg-baqh">1</td>
                            <td class="tg-yw4l">Các hãng thường lệ</td>
                            <td class="tg-yw4l"></td>
                            <td class="tg-yw4l"></td>
                        </tr>
                        <tr>
                            <td class="tg-baqh">2</td>
                            <td class="tg-yw4l">Thu tiền mặt tại sân</td>
                            <td class="tg-yw4l"></td>
                            <td class="tg-yw4l"></td>
                        </tr>
                        <tr>
                            <td class="tg-baqh">3</td>
                            <td class="tg-yw4l">Miễn thu</td>
                            <td class="tg-yw4l"></td>
                            <td class="tg-yw4l"></td>
                        </tr>
                        <tr>
