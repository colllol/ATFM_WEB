<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QC14.aspx.cs" Inherits="prjApplication.ReportBTC.QC.QC14" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>+ BIÊN BẢN ĐỐI CHIẾU SỐ LIỆU ĐIỀU HÀNH BAY QUA CÁC HÃNG HÀNG KHÔNG BAY QUA FIR HÀ NỘI</title>
                    ...
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">
                                BIÊN BẢN ĐỐI CHIẾU SỐ LIỆU ĐIỀU HÀNH BAY QUA <br />
                                CÁC HÃNG HÀNG KHÔNG BAY QUA FIR HÀ NỘI<br />
                                QUÝ ….NĂM 201.... 
                            </td>                                                     
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">Giữa Trung tâm Quản lý luồng không lưu và Công ty QLB Miền Bắc</td>
                        </tr>
                    </table>
