<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QC06.aspx.cs" Inherits="prjApplication.ReportBTC.QC.QC06" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>+ BÁO CÁO SỐ LIỆU BAY QUA FIR HỒ CHÍ MINH THEO HÃNG</title>
            ...
            <tr>
                <td>
                    <table class="tblHeader" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-asmn" colspan="3">BÁO CÁO SỐ LIỆU BAY QUA FIR HỒ CHÍ MINH THEO HÃNG
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="tg" style="undefined; table-layout: fixed; width: 100%">
                        ...
                        <tr>
                            <td class="tg-031e" colspan="2"><b>TỔNG</b></td>                            
                            <td class="tg-yw4l"></td>
                            <td class="tg-yw4l"></td>
                            <td class="tg-yw4l"></td>
