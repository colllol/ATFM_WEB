<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ATMGetData.aspx.cs" Inherits="prjApplication.ATM.ATMGetData" %>
                ...
                <div class="classSearchHeader">
                    <table border="0" cellspacing="1px" cellspacing="1px" style="text-align: right; width: 100%">
                        <tr>
                            ...
                            <td>
                                Select
                                <asp:DropDownList runat="server" ID="ddlKV">
                                    <asp:ListItem Text="Miền Bắc" Value="MB"></asp:ListItem>
                                    <asp:ListItem Text="Miền Nam" Value="MN"></asp:ListItem>
                                    <asp:ListItem Text="Miền Trung" Value="MT"></asp:ListItem>
                                </asp:DropDownList>
                                 Date
                 ...
                 <tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <a href='<%# System.Configuration.ConfigurationManager.AppSettings["ATMPATH"] %>MB/<%# Eval("Dateupdate").ToString().Replace("_","/") %>/<%# Eval("Name") %>' title="Download Document">
