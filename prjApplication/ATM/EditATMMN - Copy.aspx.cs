...
{
    public partial class EditATMMN :  PageBaseCallBack
    {
        private const string _AliasSession = "EditATMMN";
        ...
        public void Upload()
        {
            ...
            string _r = System.Configuration.ConfigurationManager.AppSettings["FileUploadPathMN"];
            ...
            try
            {
                ...
                if (System.IO.Directory.Exists(Path))
                {
                    ...
                    for (int RowNo = 0; RowNo <= arFileList.Length - 1; RowNo++)
                    {
                        ...
                        _obj.InsertATMExp(lstFileName.Trim(), "", "MN", _pathdate);
                    }
                }
        ...
        protected void grdSource_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "DeleteByID":
                    ...
                    _obj.DeleATMExp(Name.ToString(), "MN", _pathdatesave);
                    LoadFilesFromPath(_r + _pathdate + "\\", sFileExt);

                    break;
                case "View":
                    Response.Redirect(path + "MN/" + _pathdate + "/" + Name.ToString());
                    break;
            }
        }
