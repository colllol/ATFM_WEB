<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ATMMT.aspx.cs" Inherits="prjApplication.ATM.ATMMT" %>
                 ...
                 <tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <a href='<%# System.Configuration.ConfigurationManager.AppSettings["ATMPATH"] %>MT/<%# Eval("Dateupdate").ToString().Replace("_","/") %>/<%# Eval("Name") %>' title="Download Document">
