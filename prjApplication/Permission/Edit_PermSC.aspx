<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="Edit_PermSC.aspx.cs" Inherits="prjApplication.Permission.Edit_PermSC" %>
        ...
        <table style="width:100%;border:0px solid black;">                                                                          
            ...
            <tr  valign="top">
                    ...
                    <fieldset class="box-border">
                        ...
                        <table style="width:100%;border:0px solid black;">
                            ...
                            <option value="O/F">O/F</option>
                                ...
                                <td><label for="txtFLIGHTTYPE" style="font-size: 12px;">F Type</label><br /> <select style="height:25px;" id="ddlFLIGHTTYPE" class="wid_60px">
                            ...
                            <tr>
                            <td colspan="7"> <label for="txtREFERENCE" style="font-size:12px;">Reference</label><br />
                        <textarea id="txtREFERENCE" maxlength="4000" data-control="update"
                            rows="3" class="wid_80" data-toggle="tooltip"  title="Limit 4000 character !"></textarea> 
                ...
                OnUploadedComplete="AsyncFileUpload1_UploadedComplete" ClientIDMode="AutoID" />
                                      ...
                                      <textarea id="txtPERMCONTENT"  rows="3" data-control="update"
                            class="wid_100" data-toggle="tooltip"   ></textarea>
                                  </td>

                             </tr>
                                <tr style="text-align:center;"><td><button id="btnPrint" type="button" class="btn btn-primary" onclick="btnPrint_OnClick()">Print</button></td></tr>
                             <tr>
                                 <td>
                                     <label for="txtBILLINGADDRESS" style="font-size:12px;">Billing address</label><br />
                        <textarea rows="3" id="txtBILLINGADDRESS" maxlength="4000" data-control="update"
    ...
    <script>
        ...
        function btnGenMessageText(){           
            ...
            $.ajax({
                ...
                method: "PUT",
                url: url,
                data: JSON.stringify({ TYPE_ID: 1, PERMID: $('#perm_id').html(), DATE_FLY: dateFormat(new Date().setDate(new Date().getDate()), 'dd-mm-yyyy').replace(/^(\d{2})\-(\d{2})\-(\d{4})$/, '$3/$2/$1') }),
            }).always(function (data) {
    ...
    <script>
        ...
        function checkInputDay(ele) {
            ...
            if (v.length == 10) {                
                ...
                if (!chk) {
                    alert("Wrong date format");_bool=false;
                } 
            }
            return _bool;
        }
            ...
            $.ajax({
                ...
                $.each(data.ListValue, function(a,b){
                    ...
                    + "<td style=\"white-space: nowrap;>\"" 
                                ...
                                + "<i id=\"btnDelete_"+b.ID+"\" class=\"ace-icon fa fa-trash-o bigger-130 hidden\" onclick=\"btnDeleteOnclick("+b.ID+");\"></i></a>":"")
        ...
        window.onkeydown = function(e) {
            ...
            if (charCode == 118) {                
                var _tr ="<tr id='_"+c+"' data-isInsert='true' onmouseover=\"rowId=$(this).prop('id');\" onmouseout='rowId=0;'>"
                   +  "<td id='b_"+c+"'>" +  (c-1) + "</td>"
                   + "<td><input type='text' data-control='_updateAll' data-minlenght='3' maxlength='8' class='sInput' id='txtFLIGHTNBR"+c+"' value='" + $('#ddlOPER_ID').val() + "' onchange='checkIsUpdate(this)' /></td>"
