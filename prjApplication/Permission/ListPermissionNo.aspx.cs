...
namespace prjApplication.Permission
{
    public partial class ListPermissionNo : PageBaseCallBack
    {
        ...
        public override string GetCallbackResult()
        {
            ...
            switch (_arg[1])
            {
                ...
                case "btnSearchExtension_Click":
                    ...
                    break;
                case "LoadPermDetailNoActionHistory":
                    kq = LoadPermDetailNoActionHistory(_arg[0]);
                    break;
            }
            return kq;
        }
        ...
        private string LoadPermDetailNoActionHistory(string permIdValue)
        {
            long permId;
            ...
            try
            {
                DataTable history = new PermDetailNoDAL().GetActionHistoryByPermId(permId);
