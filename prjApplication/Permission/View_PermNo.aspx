<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFMNoneMenu.Master" AutoEventWireup="true"
    CodeBehind="View_PermNo.aspx.cs" Inherits="prjApplication.Permission.View_PermNo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="perm_id" hidden="hidden"><%= Request.QueryString["ID"]==null?"": Request.QueryString["ID"]%>
    </div>
                ...
                <td style="width: 50%">
                    <fieldset class="box-border">
                        ...
                        <input id="ddlOPER_ID" type="text" class="wid_400px" data-autocomplete="OPER" data-minlenght="1"
                            data-control="update" />
                        <%--<asp:DropDownList ID="ddlOPER_ID" runat="server" CssClass="wid_400px">
                        </asp:DropDownList>--%>
                    </fieldset>
                </td>
                    ...
                    <fieldset class="box-border">
                        ...
                        <table style="width: 100%; border: 0px solid black;">
                            <tr>
                                ...
                                <td>
                                    <label for="txtPERMTYPE" style="font-size: 12px;">Type</label><br />
                            ...
                            <tr>
                                <td colspan="6">
                                    ...
                                    <textarea id="txtREFERENCE" rows="3" class="wid_80" data-control="update" data-toggle="tooltip"
                            ...
                            <tr>
                                <td>
                                   <label for="txtBILLINGADDRESS" style="font-size: 12px;">Billing address</label><br />
                                    <textarea id="txtBILLINGADDRESS" class="wid_100" data-control="update" rows="2"  data-toggle="tooltip"
                                        title="Limit 4000 character !"></textarea>
            ...
            <tr>
                <td colspan="2">
                     <label for="txtCONTENT" style="font-size: 12px;">Perm Content</label><br />
                                    <textarea id="txtPERMCONTENT" class="wid_100" data-control="update" rows="30" data-toggle="tooltip"
                                        title="Limit 4000 character !"></textarea>
                </td>
            </tr>
        </table>
    ...
    <table id="tblSource">
        <thead>
            ...
            <tr>
                <th>
                    <input id="txtFLIGHTNBR" runat="server" type="text" class="wid_100px" data-control="btnUpdate"
                        maxlength="20"
                        data-minlenght="1" /></th>
                <th>
                ...
                <th style="white-space: nowrap; background-color: #fff">
                    <div class="action-buttons">
                        ...
                        <a id="lnkCreate" onclick="mbtnAddNewFlightDetailOnclick()">
                        ...
                        <td>
                            <div class="action-buttons" style="width: 70px">
                                <a id="A1" runat="server" data-toggle="tooltip" title="Edit">
                                    <i class="ace-icon fa fa-pencil bigger-130" onclick="mShowDetail(<%# Eval("ID") %>);">
                                    </i>
                                </a>
    ...
    <script>
        ...
        function mGetObjectInfo() {
            ...
            if ($('#tblSource').attr('data-pageSize') == null) $('#tblSource').attr('data-pageSize', 150);
    ...
    <script>
        ...
        function LoadDataAjax() {
            if ($('#perm_id').html().trim() == '') return;
            if ($('#perm_id').html().trim() != '') $('#btnUpdatePermMaster').show();
            var kq = '';
            var $request = $.ajax({
                //async: false,
                method: "PUT",
        ...
        window.onkeydown = function (e) {
            ...
            var _tr = $("<tr id='_" + c + "' data-isInsert='true' onmouseover=\"rowId=$(this).prop(\'id\');\" onmouseout='rowId=0;' class='rowCreate'>"
                    //+  "<td id='b_"+b.RNUM+"'>" +  b.RNUM + "</td>"
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='4' maxlength='8' class='sInput' id='txtFLIGHTNBR" + c + "' value='" + $('#ddlOPER_ID').val() + "' onblur='checkIsUpdate(this)' /></td>"
