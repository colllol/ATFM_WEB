<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="EditPermNo.aspx.cs" Inherits="prjApplication.Permission.EditPermNo1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <button type="button" id="btnUpdateList" style="display:none;" class="btn btn-sm btn-primary" onclick="btnUpdateList_Onclick()">
        Update all</button>
    <button type="button" id="btnGenList" class="btn btn-sm btn-primary" onclick="btnUpdate_GenBack()">
        Gen Flights</button>
    ...
    <script>
        ...
        function LoadDataAjax() {
            ...
            var $request = $.ajax({
                //async: false,
                method: "PUT",
                url: urlApi + "api/PermDetailNo/GetBySearch_New",
                data: mGetObjectInfo(),
                beforeSend: function () {
                    $('#tblSource tbody tr').remove();
       ...
       function btnUpdate_GenBack_NoConfirm() {
        ...
        function btnGenMessageText() {
            ...
            $.ajax({
                ...
                method: "PUT",
                url: url,
                data: JSON.stringify({ TYPE_ID: 2, PERMID: $('#perm_id').html(), DATE_FLY: dateFormat(new Date().setDate(new Date().getDate() + 1), 'dd-mm-yyyy').replace(/^(\d{2})\-(\d{2})\-(\d{4})$/, '$3/$2/$1') }),
            }).always(function (data) {
