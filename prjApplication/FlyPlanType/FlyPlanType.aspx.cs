...
namespace prjApplication.FlyPlanType
{
    public partial class FlyPlanType : PageBaseCallBack
    {
        public string _phanCach = "::::";
        public string _IdSelect = "0";
        private string _AliasSession = "FlyplanType";
        ...
        private string LoadDataGrid(string[] thamso)
        {
            ...
            System.Data.DataTable t = new prjBusinessLogic.FlyPlanTypeDAL().GetPage(GetSearch());
            if (t != null)
        ...
        private clsSearchFlyplanType GetSearch()
        {
            clsSearchFlyplanType obj = new clsSearchFlyplanType();
        ...
        {
            string _str;
            _str =  new FlyPlanTypeDAL().GetOne(thamso).Rows[0]["CONTENT3"].ToString();
