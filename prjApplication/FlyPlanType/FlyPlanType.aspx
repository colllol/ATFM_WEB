<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="FlyPlanType.aspx.cs" Inherits="prjApplication.FlyPlanType.FlyPlanType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="TitlePanel">+ FLYPLAN TYPE</span>
        ...
        <asp:GridView ID="grdSource" runat="server" CssClass="table table-bordered table-hover"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="CONTENT">
                    ...
                    <ItemTemplate>
                        <span onclick='GetContent("<%# Eval("NBR") %>");' onmouseover="ddrivetip('<%# Eval("CONTENT3").ToString().Replace("\n", "</br>").Replace("\"","") %>', 'yellow', 500);"
                            onmouseout="hideddrivetip();" data-toggle="modal" data-target="#popupEditFlightDetail">
                            <%# Eval("CONTENT3").ToString().Length>=60?Eval("CONTENT3").ToString().Substring(0, 60)+".....":Eval("CONTENT3").ToString() %></span>
                    </ItemTemplate>
                </asp:TemplateField>               
