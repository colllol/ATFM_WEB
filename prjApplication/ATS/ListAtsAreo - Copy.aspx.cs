...
{
    public partial class ListAtsAreo : PageCoreAdmin
    {
        ...
        {
            List<AREODROME> t = new AtsDAL().GetListPageAreo(CustomPaging1.PageSize, CustomPaging1.PageIndex, CustomPaging1.ValueSearch);
            CustomPaging1.TotalsRecord = t.GetTotalRecord<AREODROME>();
        ...
        protected void grdSource_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "DeleteByID":
                    var kq = new AtsDAL().DeleteAtsAreo(id);
