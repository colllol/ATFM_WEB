...
{
    public partial class ATS4FPL : PageBaseCallBack
    {      
        ...
        {
            AtklDAL _obj = new AtklDAL();
            DataTable t = _obj.GetFPL(txtBEGINDATE.Value);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            dt = new AtklDAL().GetFPL(txtBEGINDATE.Value);
            GridView gr = new GridView();
            gr.DataSource = dt;
            gr.DataBind();
            
            this.CreateExcel(this.RenderToHTML(gr), "ExporGetFPL.xls");
        }
