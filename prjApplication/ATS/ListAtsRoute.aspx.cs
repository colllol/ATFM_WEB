...
{
    public partial class ListAtsRoute : PageCoreAdmin
    {
        private const string _AliasSession = "ListATSROUTE";
        ...
        {
            List<ATSROUTE> t = new AtsDAL().GetListPage(CustomPaging1.PageSize, CustomPaging1.PageIndex, CustomPaging1.ValueSearch);
            CustomPaging1.TotalsRecord = t.GetTotalRecord<ATSROUTE>();
