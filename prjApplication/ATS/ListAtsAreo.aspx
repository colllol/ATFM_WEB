<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListAtsAreo.aspx.cs" Inherits="prjApplication.ATS.ListAtsAreo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-weight: bold;">+ ATS AREO DROME LIST</span>
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "LOCALTION") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
