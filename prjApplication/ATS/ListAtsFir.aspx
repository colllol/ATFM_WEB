<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListAtsFir.aspx.cs" Inherits="prjApplication.ATS.ListAtsFir" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-weight: bold;">+ ATS FIR LIST</span>
                ...
                <asp:GridView Style="border-collapse: collapse;" runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "COORDINATE") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "FIRLOWERLIMIT") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "FIRUPPERLIMIT") %>
                            </ItemTemplate>
                        </asp:TemplateField>
