...
{
    public partial class ListAtsFir : PageCoreAdmin
    {
        ...
        {
            List<AtsFIR> t = new AtsDAL().GetListPageFir(CustomPaging1.PageSize, CustomPaging1.PageIndex, CustomPaging1.ValueSearch);
            CustomPaging1.TotalsRecord = t.GetTotalRecord<AtsFIR>();
        ...
        protected void grdSource_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "DeleteByID":
                    var kq = new AtsDAL().DeleteAtsFir(id);
