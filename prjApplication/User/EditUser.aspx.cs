...
namespace prjApplication.Menu
{
    public partial class EditUser : System.Web.UI.Page
    {
        ...
        protected bool CheckValidate()
        {
            ...
            {
                System.Web.UI.ScriptManager.RegisterStartupScript(this, typeof(string), "Message", "alert('Tên truy cập lớn hơn hoặc bằng 8 ký tự!');", true);
                _return = false;
            }
            if (pnlPass.Visible)
            {
                ...
                {
                    System.Web.UI.ScriptManager.RegisterStartupScript(this, typeof(string), "Message", "alert('Mật khẩu lớn hơn 8 ký tự!');", true);
                    _return = false;
                }
            }
        ...
        protected void linkSave_Click(object sender, EventArgs e)
        {
            ...
            if (_Isobj.UserID !=0 && Request["ID"] == null)
            {
            ...
            if (CheckValidate())
            {
                if (Page.IsValid)
                {
                    int _return = Int32.Parse(_userDAL.InsertT_UsersOrc(_obj));
                    string strLog = "";
                    if (Request["ID"] == null)
                    {
