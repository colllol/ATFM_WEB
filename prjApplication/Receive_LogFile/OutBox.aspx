<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="OutBox.aspx.cs" Inherits="prjApplication.Receive_LogFile.OutBox" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="position: relative; width: 100%; height:500px">
        ...
        <div style="position: relative;max-width: 165px;overflow-y: scroll; left: 0; right: 0; max-height:100%; border: 1px black solid">
    ...
    <script>
        function btnSeacrch_OnClick() {
            ...
            var $request = $.ajax({
                method: "PUT",
                url: urlApi + "api/ApiExtension/ExcuteTable?packageName=MESSAGE_PKG&storeName=GetOutboxBySearch",
        ...
        function lblNbr_OnRowClick(id) {
            $('#lblNbr div').removeClass('select');
            var $request = $.ajax({
                method: "PUT",
                url: urlApi + "api/ApiExtension/ExcuteTable?packageName=MESSAGE_PKG&storeName=GetOutboxDetailBy",
