<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="ReceiveLogFile.aspx.cs" Inherits="prjApplication.Receive_LogFile.ReceiveLogFile" %>
    ...
    <div class="classSearchHeader">
        <table border="0" cellspacing="1px" cellspacing="1px" style="text-align: right; width: 100%">
            <tr>
                ...
                <td style="width: 5%; text-align: right;">TEXT
                </td>
                <td style="width: 10%; text-align: left;">
                    <input id="txtFROM_PL" runat="server" class="inputControl mControl"
                        type="text" />

                </td>
                <td style="width: 5%; text-align: right;">Type
                </td>
                <td style="width: 5%; text-align: left;">
                    <asp:DropDownList runat="server" ID="ddlTypeMessage">
                        <asp:ListItem Text="--" Selected="True" Value="0">                                
                        </asp:ListItem>
                        <asp:ListItem Text="FPL" Value="FPL">                                
                        </asp:ListItem>
                        <asp:ListItem Text="DEP" Value="DEP">                                
                        </asp:ListItem>
                        <asp:ListItem Text="ARR" Value="ARR">                                
                        </asp:ListItem>
                        <asp:ListItem Text="DLA" Value="DLA">                                
                        </asp:ListItem>
                        <asp:ListItem Text="CNL" Value="CNL">                                
                        </asp:ListItem>
                        <asp:ListItem Text="CHG" Value="CHG">                                
                        </asp:ListItem>
                        <asp:ListItem Text="Phép bay" Value="PhepBay">                                
                        </asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td style="width: 5%; text-align: right; display: none">ORIGIN
                </td>
                <td style="width: 10%; text-align: left; display: none">
                    <input id="txtORIGIN" runat="server" class="inputControl mControl"
                        type="text" />

                </td>
                <td style="width: 5%; text-align: right; display: none">NBR
                </td>
                <td style="width: 5%; text-align: left; display: none">
                ...
                <td style="width: 5%; text-align: left;">
                    <asp:Button CausesValidation="false" runat="server" ID="linkSearch" CssClass="iconFind"
                        Font-Bold="true" Text="" Width="40px" Height="38px" OnClick="btnSearch_Click">
                    </asp:Button>
                </td>
                <td style="width: 5%; text-align: left;">
        ...
        <asp:GridView ID="grdSource" runat="server" CssClass="table table-bordered table-hover"
            ...
            <Columns>
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <a href="#" onclick="window.open('<%# Page.ResolveUrl("~/SendMessage/SendMessageFlight.aspx?ID="+ HttpUtility.UrlEncode(Eval("LETTERNBR_PK").ToString()) + "&Menu_Id=" + Request.QueryString["Menu_ID"]) %>','_blank','toolbar=yes,scrollbars=yes,resizable=yes').resizeTo(window.screen.availWidth, window.screen.availHeight).moveTo(0,0)"
                ...
                <asp:BoundField DataField="FROM_PL" HeaderText="FROM_PL" />
