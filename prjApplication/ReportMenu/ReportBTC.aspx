<%@ Page Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ReportBTC.aspx.cs" Inherits="prjApplication.ReportMenu.ReportBTC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="alert alert-block alert-success">
        ...
        <strong class="green">BÁO CÁO BAN TÀI CHÍNH										
        </strong>
    </div>
    <div class="row">
