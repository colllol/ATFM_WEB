<%@ Page Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ReportScheduled.aspx.cs" Inherits="prjApplication.ReportMenu.ReportScheduled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="alert alert-block alert-success">
        ...
        <strong class="green">BÁO CÁO CHUYẾN BAY ĐỘT XUẤT										
        </strong>
    </div>
    <div class="row">
