...
{
    public partial class ReportDHB : System.Web.UI.Page
    {
        ...
        public void LoadDataCombo()
        {
            ...
            List<CraftType> taero = new CraftTypeDAL().GetAllCraftType();
            ddlCraft.DataSource = taero;
            ddlCraft.DataTextField = "Ma";
            ddlCraft.DataValueField = "CRAFT_ID";
            ddlCraft.DataBind();
        }
        public void LoadData()
        {
            ...
            //grdSource.DataBind();
            List<ReportStatic> t = new MenuReportDAL().ReportDHB_Get_All();
