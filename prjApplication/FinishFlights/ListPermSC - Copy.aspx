...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function LoadDataGrid() {
            ...
            _urlPath= "api/ApiExtension/ExcuteTable?packageName=A_TEST_SEARCH&storeName=GetScheduleDayFlight2021"
            var $request = $.ajax({
                method: "PUT",
                url: urlApi + _urlPath,
    ...
    <script type="text/javascript">
        ...
        function exportExel(_html) {
            ...
            var fileNameToSaveAs = 'exported_scheduled_flight_' + postfix + '.xls';
