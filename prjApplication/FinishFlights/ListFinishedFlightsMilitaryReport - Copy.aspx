<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true" CodeBehind="ListFinishedFlightsMilitary.aspx.cs" Inherits="prjApplication.FinishFlights.ListFinishedFlights" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="abcxyz" class="well well-sm" style="text-align: center;">
        ...
        <button type="button" id="btnSearch" class="btn btn-sm btn-primary" style="width: 100px" onclick="btnSearch_OnClick()">
            Search</button>
        <button type="button" id="btnExportExcel" class="btn btn-sm btn-primary" style="width: 100px" onclick="btnExportexcel_OnClick()">
            Export Excel</button>
