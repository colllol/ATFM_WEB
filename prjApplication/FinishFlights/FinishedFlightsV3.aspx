<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="FinishedFlightsV3.aspx.cs" Inherits="prjApplication.FinishFlights.FinishedFlightsV3" %>
                ...
                <thead>
                    <tr>
                       <th style="background-color: white;"><asp:Button ID="btnSearch" runat="server" Width="40px" Height="38px" CssClass="iconFind"
                        ...
                        <th>
                            <input type="text" class="sControl" id="txtValidateHour" maxlength="2" data-number="true" runat="server" /></th>
                        <th>
