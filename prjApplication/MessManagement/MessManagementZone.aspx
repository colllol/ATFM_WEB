<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="MessManagementZone.aspx.cs" Inherits="prjApplication.MessManagement.MessManagementZone" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="container-fluid"> 
    <div class="row w3-example" style="margin-bottom:20px;">
       ...
       <div class="row">
   <div class="col-xs-3 w3-example" style="  overflow-y: scroll;height:calc(100% - 50px);" >
                  ...
                  <asp:Repeater ID="grdListPartMessage" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width:80%;text-align:center">
                                <a style="cursor: pointer;color:<%# Eval("STATUS") %>" onclick="ViewContent(<%# Eval("PART_NO") %>, '<%# Eval("MESS_TYPE") %>')">
                                <%# Eval("MESS_TYPE") %></a></td>
                         </tr>
                        </ItemTemplate>
                </asp:Repeater>
    ...
    <div class="col-xs-9 " style="padding-left:40px;">            
