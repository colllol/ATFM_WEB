<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ListCancelFlight.aspx.cs" Inherits="prjApplication.CancelFlight.ListCancelFlight" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table id="tblSource" class="table table-bordered">
        <caption>
            <label class="radio-inline">
                <input id="chkKhb" checked onchange="chkKhb_CheckedChanged();" type="radio" name="optradio"/>LIST CANCEL FLIGHT</label>
        ...
        <thead>
            <tr style="background-color: unset" isInsertFlight="true">
                ...
                <th>
                    <input id="txtPERMNBR" class="wid_75px" type="text"   /></th>
                <th>
                ...
                <th>
                    <input id="txtVIA" class="wid_50px" type="text" /></th>
                <th>
                    <input id="txtFPLVIA" class="wid_100px" type="text" /></th>
                <th>
            ...
            <tr style="color: white">
                ...
                <th data-sort="1" onclick="sortOnclick(this);">PERMNBR</th>
                <th data-sort="1" onclick="sortOnclick(this);">OPER</th>
                <th data-sort="1" onclick="sortOnclick(this);">FLIGHTNBR</th>
                <th data-sort="1" onclick="sortOnclick(this);">PURPOSE</th>
                <th data-sort="1" onclick="sortOnclick(this);">CRAFT_TYPE</th>
               <th data-sort="1" onclick="sortOnclick(this);">CRAFT</th>
                ...
                <th data-sort="1" onclick="sortOnclick(this);">F_TYPE</th>
                
                <th data-sort="1" onclick="sortOnclick(this);">V_HOURS</th>              
    ...
    <script>
        ...
        function Render2Table(data) {           
            ...
            $.each(data.ListValue, function (a, b) {
                kq += "<tr id='" + b.FLIGHT_ID + "' data-isUpdate='false' onmouseover='rowId=" + b.FLIGHT_ID + ";' onmouseout='rowId=0;'>"
                    ...
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='1' class='sInput' id='txtFLIGHT_TYPE" + a + "' data-oldValue='" + b.FLIGHT_TYPE + "' value='" + b.FLIGHT_TYPE + "' maxlength=\"2\" onblur='checkIsUpdate(this)'/></td>"
                    
                    + "<td><input type='text' data-control='_updateAll' maxlength='2' class='sInput' id='txtVALIDHOURS" + a + "' data-oldValue='" + returnEmpty(b.VALIDHOURS) + "' value='" + returnEmpty(b.VALIDHOURS) + "' onblur='checkIsUpdate(this)'/></td>"
        ...
        function RenderTableKhDelete(data) {
            ...
            $.each(data.ListValue, function (a, b) {
                kq += "<tr>"
                    ...
                    + "<td style=\'text-align: left;\'>" + returnEmpty(b.MAYBAY) + "</td>"
        ...
        function LoadDataGrid() {
            var $request = $.ajax({
                method: "PUT",                
                url: urlApi + "api/CancelFlights/GET_CANCEL_FLIGHTS",
    ...
    <script>
        ...
        function chkKhb_CheckedChanged() {           
            $('#tblSource').attr('data-pageIndex', 0);
            btnSearch_OnClick();
        }        
        ...
        window.onkeydown = function (e) {
            ...
            if (charCode == 118) {
                ...
                _tr = "<tr id='_" + c + "' data-isInsert='true' onmouseover=\"rowId=$(this).prop('id');\" onmouseout='rowId=0;'>"
                    ...
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='1' class='sInput' id='txtPERMNBR" + c + "' value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtOPER_ID" + c + "' value='' onfocusin='binAutocomplete(this,\"OPER\")' onblur='checkIsUpdate(this)'/></td>"
                    ...
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='1' class='sInput' id='txtPURPOSE" + c + "' onfocusin='binAutocomplete(this,\"PURPOSE\")' value='' onblur='checkIsUpdate(this)'/></td>"                    
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtREALCRAFT" + c + "' value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtPERMCRAFT" + c + "' data-craftid='0' value='' onfocusin='binAutocomplete(this,\"CRAFT\")' onblur='checkIsUpdate(this)'/></td>"                    
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='2' class='sInput' id='txtFROM_AIRP" + c + "' value='' onfocusin='binAutocomplete(this,\"AERO\")' onblur='checkIsUpdate(this)' /></td>"
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='2' class='sInput' id='txtTO_AIRP" + c + "' value='' onfocusin='binAutocomplete(this,\"AERO\")' onblur='checkIsUpdate(this)'/></td>"                    
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='4' maxlength='6' class='sInput' id='txtETD" + c + "' value='' data-number='true' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtETA" + c + "' value='' data-number='true'  onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtATD" + c + "' value='' data-number='true'  onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' id='txtATA" + c + "' value='' data-number='true'  onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='1' maxlength=\"10\" data-CheckDate='true' class='sInput' id='txtFLIGHTDATE" + c + "' value='' onblur='checkIsUpdate(this)' /></td>"
                    + "<td><input type='text' data-control='_updateAll' class='sInput' id='txtREGISTRATION" + c + "' value='' onblur='checkIsUpdate(this)' /></td>"
                    + "<td><input type='text' data-control='_updateAll' class='sInput' id='txtPERMTYPE" + c + "'  value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='1' class='sInput' id='txtFLIGHT_TYPE" + c + "' value='' maxlength=\"2\" onblur='checkIsUpdate(this)'/></td>"                    
                    + "<td><input type='text' data-control='_updateAll' maxlength='2' class='sInput' id='txtVALIDHOURS" + c + "' value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' class='sInput' id='txtVIA" + c + "' value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' class='sInput' id='txtFPLVIA" + c + "' value='' onblur='checkIsUpdate(this)'/></td>"
    ...
    <script>
        ...
        function fnExcelReport() {            
            ...
            tab = document.getElementById('tblSource'); // id of table
