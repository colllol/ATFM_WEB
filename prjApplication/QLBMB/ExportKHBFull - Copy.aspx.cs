...
{
    public partial class ExportKHBFull : PageBaseCallBack
    {      
        ...
        protected void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            DataTable t = _obj.GetExportFull(txtBEGINDATE.Value);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            dt = new ScheduleDayFlightsDAL().GetExportFull(txtBEGINDATE.Value);
            //GridView gr = new GridView();
            //gr.DataSource = dt;
            //gr.DataBind();
            
            this.CreateExcel(this.RenderToHTML(grdListUser), "ExporDayFlightFull.xls");
        }
