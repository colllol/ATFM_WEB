...
{
    public partial class ExportSchedule : PageBaseCallBack
    {      
        ...
        protected void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            DataTable t = _obj.GetExportSchedule(txtBEGINDATE.Value,txtENDDATE.Value);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            dt = new ScheduleDayFlightsDAL().GetExportSchedule(txtBEGINDATE.Value, txtENDDATE.Value);
            // GridView gr = new GridView();
            //   gr.DataSource = dt;
            // gr.DataBind();
            this.CreateExcel(this.RenderToHTML(grdListUser), "ExporSchedule.xls");
        }
