<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="ExportKHBFull.aspx.cs" Inherits="prjApplication.QLBMB.ExportKHBFull" %>
   ...
   <link href="../Style/StyleReports.css" rel="stylesheet" />
    ...
    <link href="../Style/assets/css/bootstrap.min.css" rel="stylesheet" />
     ...
     <asp:Panel ID="pnlList" runat="server">
        <span style="font-weight: bold;">+ EXPORT FULL FPL</span>
                           ...
                           <asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn>
                             ...
                             <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                   <%# DataBinder.Eval(Container.DataItem, "EOBT") %>
                                </ItemTemplate>
                            </asp:TemplateColumn> 
                             <asp:TemplateColumn>
                                <HeaderStyle HorizontalAlign="Left" Width="5%"></HeaderStyle>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                   <%# CutRoute(DataBinder.Eval(Container.DataItem, "ROUTEFULL").ToString(),3) %>
                                </ItemTemplate>
                            </asp:TemplateColumn>                           
                        </Columns>
                    </asp:DataGrid>
