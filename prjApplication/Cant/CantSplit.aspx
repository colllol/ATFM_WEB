<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="CantSplit.aspx.cs" Inherits="prjApplication.Cant.CantSplit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="TitlePanel">+ CAN'T SPLIT MESSAGE</span>
        ...
        <asp:GridView ID="grdSource" runat="server" CssClass="table table-bordered table-hover"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="NBR">
                    ...
                    <ItemTemplate>   
                        <span onmouseover="ddrivetip('<%# Eval("NBR").ToString().Replace("\n", "</br>") %>', 'yellow', 500);"
                            onmouseout="hideddrivetip();">
                            <%#  Eval("NBR").ToString().Length>=60?Eval("NBR").ToString().Substring(0, 60)+".....":Eval("NBR").ToString() %></span>                     
               ...
               <asp:TemplateField HeaderText="TYPE">
                ...
                <asp:TemplateField HeaderText="LETTERNBR_PK">
                    <HeaderStyle HorizontalAlign="Center" Width="15%"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" Width="15%"></ItemStyle>
                    <ItemTemplate>
