...
{
    public partial class CantSplit : PageBaseCallBack
    {
        public string _phanCach = "::::";
        public string _IdSelect = "0";
        private string _AliasSession = "CantSplit";
        ...
        private string LoadDataGrid(string[] thamso)
        {
            ...
            List<prjInfo.CantSplit> t = new prjBusinessLogic.CantSplitDAL().GetPage(CustomPaging1.PageSize, CustomPaging1.PageIndex, CustomPaging1.ValueSearch,thamso[0].ToString(), thamso[1].ToString());
            CustomPaging1.TotalsRecord = t.GetTotalRecord<prjInfo.CantSplit>();
        ...
        {
            return new CantSplitDAL().GetOne(thamso).Rows[0]["CONTENT"].ToString();
        }
