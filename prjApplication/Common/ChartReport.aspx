...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link rel="stylesheet" data-report-interactive="true" href="<%= ResolveUrl("~/ReportNew/ReportInteractive.css?v=20260725-1") %>" />
    ...
    <script src="<%= ResolveUrl("~/ReportNew/Dashboard.js?v=20260727-1") %>"></script>
</asp:Content>
