<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="ViewPermistion.aspx.cs" Inherits="prjApplication.ViewPermistion.ViewPermistion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="TitlePanel">+ PERMISSION INBOX </span>
        ...
        <asp:GridView ID="grdSource" runat="server" CssClass="table table-bordered table-hover"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="CONTENT">
                    ...
                    <ItemTemplate>
                        <span onclick='GetContent("<%# Eval("NBR") %>");' onmouseover="ddrivetip('<%# Eval("CONTENT").ToString().Replace("\n", "</br>").Replace("\"","") %>', 'yellow', 500);"
