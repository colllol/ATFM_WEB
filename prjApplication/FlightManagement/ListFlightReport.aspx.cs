...
{
    public partial class ListFlightReport : PageBaseCallBack
    {
        public string _phanCach = "::::";
        public string _IdSelect = "0";
        private string _AliasSession = "ListFlightReport";
        ...
        {
            var ax = new clsResuftAPI().GetPostValueApiExtension("PERMISSION_SEASON", "GEN_SEASON_CALENDAR", new { PERM_TYPE="LD", SEASON="W", YEAR="2018", CALENDAR_ID=1 });
        }
