<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="ListFlight.aspx.cs" Inherits="prjApplication.FlightManagement.ListFlight" %>
        ...
        <asp:DataGrid runat="server" ID="grdSource" AutoGenerateColumns="false" DataKeyField="ID"
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    ...
                    <ItemTemplate>
                        <div class="action-buttons">
                            <% if (_Role.R_Edit) { %>
                                  <a data-toggle="tooltip" title='<%# "Edit: " + Eval("CALENDAR_NAME") %>'>
                                <i class="ace-icon fa fa-pencil bigger-130" onclick="ShowpopupEditFlight(<%# Eval("ID") %>);">
                                </i>
                            </a>
                            <% } else { %>
                                 <a>
                            ...
                            <% if (_Role.R_Del) { %>
                                  <a data-toggle="tooltip" title='<%# "Delete: " + Eval("CALENDAR_NAME") %>'>
                ...
                <asp:TemplateColumn>
                    ...
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="linkDetails" CommandArgument='<%# Eval("CALENDAR_ID") %>'
                            CommandName="RedectDetail" data-toggle="tooltip" ToolTip="Show Flight details" >
                                            (<%# Eval("CALENDAR_ID") %>)<%# DataBinder.Eval(Container.DataItem, "CALENDAR_NAME") %>
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <%--<asp:TemplateColumn>
                ...
                <asp:TemplateColumn>
                    ...
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "TYPE").ToString()=="LD"?"<span class=\"label label-sm label-warning\">"+Eval("TYPE")+"</span>":"<span class=\"label label-sm label-inverse arrowed-in\">"+Eval("TYPE")+"</span>" %>
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </asp:DataGrid>
