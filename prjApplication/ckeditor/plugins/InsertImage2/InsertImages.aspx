<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertImages.aspx.cs" Inherits="prjApplication.ckeditor.plugins.InsertImage2.InsertImages" %>
    ...
    <script type="text/javascript">
        ...
        function getImgSrc(theImagePath, numArg, Width, Height, _ID) {            
            ...
            if (theImagePath != "") {
                ...
                {
                    case 'swf':
                        stringImg = "<embed id=\"" + _ID + "\" width=\"100%\" height=\"100%\" src=\"<%=prjComponents.Global.UploadPath%>" + theImagePath + "\" quality=\"high\" wmode=\"transparent\" name=\"player\" allowscriptaccess=\"always\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\">";
                        break;
                    case 'flv':
                        stringImg = "<iframe class=\"iframebnncontentsflv\" width=\"420\" height=\"322\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlay.aspx?urlfile=" + theImagePath + "&urlimg=" + numArg + "\" ></iframe>";
                        break;
                    case 'mp4':
                        stringImg = "<iframe class=\"iframebnncontentsmp4\" width=\"420\" height=\"322\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlay.aspx?urlfile=" + theImagePath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                        break;
                    case 'mp3':
                        stringImg = "<iframe class=\"iframebnncontentsmp3\" width=\"500\" height=\"20\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlayAudio.aspx?urlfile=" + theImagePath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                        break;
                    case 'wma':
                        stringImg = "<iframe class=\"iframebnncontentswma\" width=\"500\" height=\"20\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlayAudio.aspx?urlfile=" + theImagePath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                        break;
                    case 'ocx':
                        stringImg = "";
                        break;
                    ...
                    case 'rar':
                        ...
                        break;
                    default:
                        //stringImg = "<img id=\"" + _ID + "\" style=\"cursor-pointer\" width=\"" + Width + "\" height=\"" + Height + "\" hspace=\"3\" vspace=\"3\" src=\"<%=prjComponents.Global.UploadPath%>" + theImagePath + "\" border =\"0\">";
                        stringImg = "<img id=\"" + _ID + "\" style=\"cursor-pointer\" hspace=\"3\" vspace=\"3\" src=\"<%=prjComponents.Global.UploadPath%>" + theImagePath + "\" border =\"0\">";
                        break;
                }
            ...
            for (var i = 0; i < inputList.length; i++) {
                ...
                if (inputList[i].type == "checkbox") {
                    if (inputList[i].checked) {
                        ...
                        switch (strCheck) {
                            case 'swf':
                                stringImg = "<embed id=\"" + _ID + "\" width=\"100%\" height=\"100%\" src=\"<%=prjComponents.Global.UploadPath%>" + originPath + "\" quality=\"high\" wmode=\"transparent\" name=\"player\" allowscriptaccess=\"always\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\">";
                                break;
                            case 'flv':
                                stringImg = "<iframe class=\"iframebnncontentsflv\" width=\"420\" height=\"322\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlay.aspx?urlfile=" + originPath + "&urlimg=" + numArg + "\" ></iframe>";
                                break;
                            case 'mp4':
                                stringImg = "<iframe class=\"iframebnncontentsmp4\" width=\"420\" height=\"322\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlay.aspx?urlfile=" + originPath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                                break;
                            case 'mp3':
                                stringImg = "<iframe class=\"iframebnncontentsmp3\" width=\"500\" height=\"20\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlayAudio.aspx?urlfile=" + originPath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                                break;
                            case 'wma':
                                stringImg = "<iframe class=\"iframebnncontentswma\" width=\"500\" height=\"20\" frameborder=\"0\"  src=\"<%=prjComponents.Global.MultimediaPath%>/Ajax/PluginPlayAudio.aspx?urlfile=" + originPath + "&urlimg=" + numArg + "\" allowfullscreen=\"\"></iframe>";
                                break;
                            case 'ocx':
                                stringImg = "";
                                break;
                            ...
                            case 'rar':
                                ...
                                break;
                            default:
                                //stringImg = "<img id=\"" + _ID + "\" style=\"cursor-pointer\" width=\"" + _Width + "\" height=\"" + _Height + "\" hspace=\"3\" vspace=\"3\" src=\"<%=prjComponents.Global.UploadPath%>" + originPath + "\" border =\"0\">";
                                stringImg = "<img id=\"" + _ID + "\" style=\"cursor-pointer\"  hspace=\"3\" vspace=\"3\" src=\"<%=prjComponents.Global.UploadPath%>" + originPath + "\" border =\"0\">";
                                break;
                        }
                        InsertImg(stringImg);
                    }
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;">
                                        <nbc:NetDatePicker ImageUrl="../../../Images/events.gif" ImageFolder="../../../Scripts/DatePicker/Images"
                                            ...
                                            onKeyUp="DateFormat(this,this.value,event,false,'3')" onBlur="DateFormat(this,this.value,event,true,'3')"></nbc:NetDatePicker>
                                        <asp:DropDownList CssClass="inputtext" runat="server" ID="ddlStock" Width="180px" AutoPostBack="true"
                                            onclick="javascript:run_upload();" OnSelectedIndexChanged="ddlStock_OnSelectedIndexChanged">
...
<script type="text/javascript">
    ...
    function run_upload() {
        ...
        $("#<%=FileUpload1.ClientID %>").uploadify({
            ...
            'uploader': '../insert_image/UploadImgEditor.ashx?user=<%=GetUserName()%>&watermark=' + str + '&inStock=' + _strStock,
            'folder': 'Upload',
