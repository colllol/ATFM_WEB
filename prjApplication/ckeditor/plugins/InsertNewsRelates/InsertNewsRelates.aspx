<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertNewsRelates.aspx.cs"
    Inherits="prjApplication.ckeditor.plugins.InsertNewsRelates.InsertNewsRelates" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Send_NewsRelates() {
            var strBuild = "";
            var id = '<%=Request["editorID"] %>';
            var strstring = " <span style='font-size:10px;'>&gt;&gt;</span>";
            var _break = "";
            if (id == 'ctl00_MainContent_txt_tomtat')
                strstring = " / ";
            if (id == 'ctl00_MainContent_txt_noidung')
                _break = "<br>";
            var elm = document.FormNews.elements;
            for (i = 0; i < elm.length; i++) {
                if (elm[i].type == "checkbox" && elm[i].id != 'dgr_tintuc1_ctl01_chkAll') {
                    if (elm[i].checked) {
                        var ID = 'iStr' + elm[i].name;
                        //strBuild +=document.getElementById(ID).value + "<br>";
                        strBuild += strstring + document.getElementById(ID).value + _break;
                    }
                }
            }
            window.opener.InsertImage(id, strBuild);
            window.close();
        }
    </script>

    <script language="javascript" type="text/javascript" src="../../../Scripts/hpc.js"></script>
                ...
                <td style="text-align: center">
                    <table style="border: 0" width="100%" cellpadding="2" cellspacing="2">
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:CheckBox runat="server" Text="Bài đinh" ID="chkNewsIsBaidinh" class="ChkBoxTit"
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <nbc:NetDatePicker ImageUrl="../../../Images/events.gif" ImageFolder="../../../Scripts/DatePicker/images/"
                                    CssClass="inputtext" Width="152px" ScriptSource="../../../Scripts/datepicker.js"
                    ...
                    <table width="100%" cellspacing="2" cellpadding="2" border="0">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="<%$ Resources:Strings, BA_QLND_NEWS_NAME %>">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <input type="hidden" id='iStr<%#Eval("News_ID") %>' value="<a class='relativehome' href='#<%#Eval("News_ID") %>'><%#ValidateString(Eval("News_Tittle"))%></a>" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="button" id="btn_OkInsert" class="iconPub" value="Đồng ý" onclick="Send_NewsRelates();" />
