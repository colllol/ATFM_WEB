...
namespace prjApplication.ckeditor.plugins.insert_image
{
    /// <summary>
            ...
            try
            {
                ...
                if (Global.UseUpload_FTP == 1)
                {
                    ...
                    if (IsImage(postedFile))
                    {
                        ...
                        _obj = SetItem(fileSave, postedFile.ContentLength, fileURL, extenfile, Convert.ToInt16(strUserID), Convert.ToInt16(vType), CATID, inStock);                        
