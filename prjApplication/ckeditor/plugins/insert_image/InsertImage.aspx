<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertImage.aspx.cs" Inherits="prjApplication.ckeditor.plugins.insert_image.InsertImage" %>
            ...
            if (theImagePath != "") {
                ...
                switch (strCheck)//ADD By CaoTienBo
                {
                    ...
                    case 'wma':
                        ...
                        break;
                    case 'ocx':
                        stringImg = "<a class=\"linkAttach\" href=\"<%=prjComponents.Global.UploadPath%>" + theImagePath + "\">" + textseleted_ + "</a>";
                        break;
                    case 'doc':
                        stringImg = "<a class=\"linkAttach\" href=\"<%=prjComponents.Global.UploadPath%>" + theImagePath + "\">" + textseleted_ + "</a>";
                        break;
                    ...
                    if (inputList[i].checked) {
                        ...
                        switch (strCheck) {
                            ...
                            case 'wma':
                                ...
                                break;
                            case 'ocx':
                                stringImg = "<a class=\"linkAttach\" href=\"<%=prjComponents.Global.UploadPath%>" + originPath + "\">" + textseleted_ + "</a>";
                                break;
                            case 'doc':
                                stringImg = "<a class=\"linkAttach\" href=\"<%=prjComponents.Global.UploadPath%>" + originPath + "\">" + textseleted_ + "</a>";
                                break;
...
<script type="text/javascript">
    ...
    function run_upload() {
        ...
        $("#<%=FileUpload1.ClientID %>").uploadify({
            ...
            'uploader': 'UploadImgEditor.ashx?user=<%=GetUserName()%>&watermark=' + str + '&inStock=' + _strStock,
            'folder': 'Upload',
