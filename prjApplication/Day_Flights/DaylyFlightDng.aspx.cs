...
{
    public partial class DaylyFlightDNG : PageBaseCallBack
    {
        protected string _DanhSachSanBayDNG = "VVDN,VVDL,VVNT,VVVT";
        ...
        private string btnSearch_Onclick(string thamso)
        {
            ...
            switch (obj.OptionDate)
            {
                case "0":
                    ...
                    dt = new DayFlightsDAL().GetTableWithValueSearch_DNG(obj);
                    break;
                case "-1":
