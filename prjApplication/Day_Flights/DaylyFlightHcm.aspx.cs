...
{
    public partial class DaylyFlightHcm : PageBaseCallBack
    {
        protected string _DanhSachSanBayHCM = "VVTS,VVPR,VVBH,VVCA";
        ...
        protected string RenderTopBar()
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Trace.TraceWarning(
                    "DaylyFlightHcm.RenderTopBar: không tải được dữ liệu Top Bar. {0}",
        ...
        private string btnSearch_Onclick(string thamso)
        {
            ...
            switch (obj.OptionDate)
            {
                case "0":
                    ...
                    dt = new DayFlightsDAL().GetTableWithValueSearch_HCM(obj);
                    break;
                case "-1":
            ...
            DataTable dt)
        {
            ...
            foreach (DataRow r in dt.Rows)
            {
                ...
                c0 = $"<td style=\"width:18px;\" class=\"tdIconStatus\">"
                      + "<div id='divStatusIcon' class='action-buttons wid_20px'>"
