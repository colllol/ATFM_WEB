<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="DaylyFlightChange.aspx.cs" Inherits="prjApplication.Day_Flights.DaylyFlightChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <table id="grdSource" class="table table-bordered">
                <thead>
                    <tr class="Spec">
                        ...
                        <td class="headSpec"><input type="text" class="sControl" id="txtREGISTRATION" /></td>
                        <td class="headSpec">
    ...
    <script>
        ...
        function DisplayResult(resulf, context) {
            ...
            else if (context == 'btnAccessInfoChange_Onclick') {
                $('#divExcuteScript').html(resulf);
                btnSearch_Onclick();
            }
        }
