...
{
    public partial class DaylyFlightCancel : PageBaseCallBack
    {
        ...
        private string ContentRowGrdSource(DataTable dt)
        {
            ...
            foreach (DataRow r in dt.Rows)
            {
                ...
                {
                    c3 = $"<td class=\"cssTdCallSignAr\"><b>{cellHasSpan(r["FLIGHTNBR"].ToString())}</b></td>";
                }
                else
                {
        ...
        {
            return RenderGrdSource_First(new DayFlightsDAL().GetTableNgayNCong1(new clsDaylyFlightSearch() { KHUNGGIO1 = "0000", KHUNGGIO2 = "2359", RowStart = 1, RowFinish = 30, PERMTYPE = "", FLIGHTDATE = DateTime.Today.AddDays(-1) }));
        }
        /// <summary>
        /// 
        /// </summary>
