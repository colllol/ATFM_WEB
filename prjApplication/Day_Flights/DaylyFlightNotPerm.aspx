<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFMNoneMenu.Master" AutoEventWireup="true"
    CodeBehind="DaylyFlightNotPerm.aspx.cs" Inherits="prjApplication.Day_Flights.DaylyFlightNotPerm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        #divSelectDate {
         ...
         #grdSource tbody tr.selectdel {
            background-color:lightcoral;
        }   
          #grdSource tbody tr.selectdxl {
    ...
    <div class="row">
        <div class="divHeader">
            <div id="infoTotal">
               <span>List flight not permission</span>
            </div>
            <div id="topBar1">
            ...
            <table id="grdSource" class="table table-bordered">
                <thead>
                    ...
                    <tr>
                        ...
                        <th data-sort="1" onclick="sortOnclick(this);">MSG CODE</th>
                    ...
                    <div class="wid_50">
                        ...
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <input id="txtContentChange" type="text" class="wid_320px" />
                            </div>
                        </div>
                        <div class="form-horizontal" role="form">
                            <div class="form-group">                                
    ...
    'viewPopupInfoExtension');
        ...
        function btnUpdateStatusLetter_OnClick(id) {
            alert(id);
            if ($('#txtContentChange').val() == '') return;
            var url = urlApi + "api/ApiExtension/ExcuteReturnInt?packageName=FLIGHT_DAYFLIGHT&storeName=updateFlightBy_Xuly";
            $.ajax({
                async: false,
                method: "PUT",
                url: url,
                data: JSON.stringify({ P_ID: id, P_USER: '<%= _user.UserName%>', P_LETTER_TYPE: $('#txtContentChange').val().toUpperCase(), P_STATUSXL: 1 }),
            }).always(function (data) {
        ...
        function btnUpdateStatusLetter_New_OnClick(id) {
            ...
            $.ajax({
                ...
                method: "PUT",
                url: url,
                data: JSON.stringify({ P_ID: id, P_USER: '<%= _user.UserName%>', P_LETTER_TYPE: 'ĐÃ XỬ LÝ', P_STATUSXL: 1 }),
            }).always(function (data) {
                if (data.ListValue == null || data.ListValue == -1) {
                    alert('Update error!');
                } else
