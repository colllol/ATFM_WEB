...
<style>
    ...
    .slots-toolbar { display:flex; align-items:center; flex-wrap:wrap; gap:9px; margin-bottom:12px; padding:12px 14px; border:1px solid #c7ddeb; border-radius:10px; background:#f2f8fc; box-shadow:0 4px 12px rgba(27,76,112,.08); }
    .slots-toolbar label { margin:0; color:#315b79; font-weight:600; }
    .slots-toolbar select, .slots-toolbar input[type="text"] { height:36px; border:1px solid #8eb9d6; border-radius:7px; background:#fff; }
    .slots-toolbar input[type="text"] { width:min(460px,100%); padding:7px 10px; }
    .slots-toolbar .slots-grow { flex:1 1 300px; }
    .slots-toolbar .btn { min-height:36px; }
    ...
    @media (max-width:767px) {
        ...
        .slots-toolbar input[type="text"] { width:100%; }
...
<div class="slots-page">
    ...
    <div class="slots-toolbar">
        <asp:TextBox ID="txtSearch" runat="server" CssClass="slots-grow" placeholder="Tìm trên các cột dữ liệu..." />
