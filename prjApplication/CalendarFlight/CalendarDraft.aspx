<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true" CodeBehind="CalendarDraft.aspx.cs" Inherits="prjApplication.CalendarFlight.CalendarDraft" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="TitlePanel">+ List draft</span>
    <div class="well well-sm" style="text-align: center;">
        ...
        <asp:LinkButton runat="server" Visible="false" ID="lbnCreate" CssClass="btn btn-sm btn-primary btn-bold" data-toggle="modal" data-target="#MultiAdd">
                                                    <span class="glyphicon glyphicon-download-alt"></span>
                                                    Create
        </asp:LinkButton>
        <input id="txtFromDate" visible="false" data-minlengt="1" data-control="_checkValid" runat="server" type="text" data-date-format="dd/mm/yyyy"
                class="date-picker" placeholder="select date" />
        <asp:Button ID="btnRenderKhb" Visible="false" runat="server" CssClass="btn btn-sm btn-primary btn-bold" OnClick="btnRenderKhb_Click" Text="Export" />
        <asp:Button ID="btnRenderKhb_2" Visible="false" runat="server" CssClass="btn btn-sm btn-primary btn-bold" OnClick="btnRenderKhb_2_Click" Text="Export Airport" />
        ...
        <table id="tblSource" class="table table-bordered table-responsive">
            <thead>
                <tr>
                    ...
                    <th>
                        <input type="text" class="sControl date-picker" id="txtFLIGHTDATE1" data-date-format="dd/mm/yyyy" runat="server" />
                    </th>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <div class="action-buttons">
                                    <a runat="server" hidden='<%# !_Role.R_Edit?"":"hidden" %>' data-toggle="tooltip" title="Edit">
                                    ...
                                    <asp:LinkButton ID="lbDelete" runat="server" CommandName="Delete" OnClick="lbDelete_Click" CommandArgument='<%# Eval("FLIGHT_ID") %>'>
                                        <i class="glyphicon glyphicon-trash"></i>
                                    </asp:LinkButton>
