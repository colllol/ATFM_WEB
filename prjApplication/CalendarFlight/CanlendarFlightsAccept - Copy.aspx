<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM.Master" AutoEventWireup="true"
    CodeBehind="CanlendarFlightsAccept.aspx.cs" Inherits="prjApplication.CalendarFlight.CanlendarFlightsAccept" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function LoadDataGrid() {
            var $request = $.ajax({
                method: "PUT",
                url: urlApi + "api/KeHoachBay/GetKeHoachBayFull",
        ...
        function LoadDataGrid_Origin() {
            var $request = $.ajax({
                ...
                document.getElementById("pageging").innerHTML = "Tổng số :" + data.ListValue[0]['TOTALRECORDS'] + " chuyến";
                var strAppend = RenderTableKhbVenh(data);
                $('#tblSource tbody').append(strAppend);
            });
            $request.onreadystatechange = null;
        ...
        window.onkeydown = function (e) {
            ...
            if (charCode == 118) {
                ...
                _tr = "<tr id='_" + c + "' data-isInsert='true' onmouseover=\"rowId=$(this).prop('id');\" onmouseout='rowId=0;'>"
                    ...
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='4' maxlength='8' style='background-color:darkkhaki;'  class='sInput' id='txtFLIGHTNBR" + c + "'  value='' onblur='checkIsUpdate(this)' /></td>"
                    ...
                    + "<td><input type='text' data-control='_updateAll' data-minlenght='4' maxlength='6' class='sInput' style='background-color:darkkhaki;' id='txtETD" + c + "'  data-number='true' value='' onblur='checkIsUpdate(this)'/></td>"
                    + "<td><input type='text' data-control='_updateAll' maxlength='6' class='sInput' style='background-color:darkkhaki;' id='txtETA" + c + "'  data-number='true' value='' onblur='checkIsUpdate(this)'/></td>"
