<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ATFM_New.Master" AutoEventWireup="true"
    CodeBehind="CalendarDayFlight.aspx.cs" Inherits="prjApplication.CalendarFlight.CalendarDayFlight" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="well well-sm" style="text-align: center;">
        ...
        <asp:Button runat="server" ID="btnAccess" OnClientClick="return confirm('Do you want confirm');" CssClass="btn btn-sm btn-primary btn-bold" Text="Accept" OnClick="btnAccess_Click"/>
        ...
        <%--<asp:Button ID="btnRenderKhb_2" OnClientClick="return confirm('Do you want confirm');" runat="server" CssClass="btn btn-sm btn-primary btn-bold" OnClick="btnRenderKhb_2_Click" Text="Export Airport" />--%>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <div class="action-buttons">
                                    <a runat="server" runnat="server" visible="<%# _Role.R_Edit %>" data-toggle="tooltip" title="Edit">
                                    ...
                                    <asp:LinkButton ID="lbDelete" runat="server" Visible="<%# _Role.R_Del %>" CommandName="Delete" OnClick="lbDelete_Click" CommandArgument='<%# Eval("FLIGHT_ID") %>'>
                                        <i class="glyphicon glyphicon-trash"></i>
                                    </asp:LinkButton>
